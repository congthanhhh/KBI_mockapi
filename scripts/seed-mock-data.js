...
const files = {
    ...
    "purchase-orders": [
        ...
        base({ id: "po_015", po_no: "PO-KBI-2026-015", supplier_id: "sup_sdec", po_type: "IMPORT", incoterm_id: "inc_fob", payment_term: "30% deposit, 70% before shipment", currency_code: "USD", exchange_rate: 25000, quotation_id: "qt_025", status: "CONFIRMED", expected_etd: "2026-07-30", expected_eta: "2026-08-07", origin_port: "Fuzhou Port", destination_port: "Cat Lai Port", notes: "Reversed-flow golden chain: created from confirmed quotation qt_025." }),
        base({ id: "po_016", po_no: "PO-KBI-2026-016", supplier_id: "sup_shanghai_oem", po_type: "IMPORT", incoterm_id: "inc_fob", payment_term: "Net 30", currency_code: "USD", exchange_rate: 25000, status: "CONFIRMED", expected_etd: "2026-08-12", expected_eta: "2026-08-18", origin_port: "Shanghai Port", destination_port: "Cat Lai Port", notes: "Backs early-stage DO demo (draft/created/ready/quotation-confirmed)." }),
        base({ id: "po_017", po_no: "PO-KBI-2026-017", supplier_id: "sup_sdec", po_type: "IMPORT", incoterm_id: "inc_fob", payment_term: "Net 30", currency_code: "USD", exchange_rate: 25000, status: "CONFIRMED", expected_etd: "2026-08-14", expected_eta: "2026-08-20", origin_port: "Fuzhou Port", destination_port: "Cat Lai Port", notes: "Backs the visible cancelled DO demo." }),
        base({ id: "po_018", po_no: "PO-KBI-2026-018", supplier_id: "sup_shanghai_oem", po_type: "IMPORT", incoterm_id: "inc_cfr", payment_term: "Net 45", currency_code: "USD", exchange_rate: 25000, status: "SHIPPED", expected_etd: "2026-07-22", expected_eta: "2026-07-28", origin_port: "Shanghai Port", destination_port: "Cat Lai Port", notes: "Backs the warehouse-pending DO demo (goods arrived, no active shipment)." }),
        base({ id: "po_019", po_no: "PO-KBI-2026-019", supplier_id: "sup_sdec", po_type: "IMPORT", incoterm_id: "inc_fob", payment_term: "LC at sight", currency_code: "USD", exchange_rate: 25000, status: "SHIPPED", expected_etd: "2026-07-16", expected_eta: "2026-07-22", origin_port: "Shanghai Port", destination_port: "Hai Phong Port", notes: "Backs the customs-processing DO demo (linked shipment in customs draft)." })
    ],
    ...
    "shipments": [
        ...
        base({ id: "shp_006", shipment_no: "SHP-KBI-2026-006", delivery_order_id: "do_006", mode: "AIR", load_type: null, forwarder_id: "fwd_001", carrier_id: "carr_009", carrier: "Turkish Airlines", vessel_flight: "CX052", bl_awb_no: "AWB-006", container_no: null, pol: "PVG", pod: "HAN", etd: "2026-08-04", eta: "2026-08-05", atd: "2026-08-04", ata: null, status: "ATD" }),
        base({ id: "shp_007", shipment_no: "SHP-KBI-2026-007", delivery_order_id: "do_007", mode: "SEA", load_type: "LCL", forwarder_id: "fwd_001", carrier_id: "carr_005", carrier: "WAN HAI Lines Ltd.", vessel_flight: "SITC HAIPHONG 088S", bl_awb_no: "BL-NGB-007", container_no: "LCL-NGB-007", pol: "CNNGB", pod: "VNHPH", etd: "2026-06-30", eta: "2026-07-08", atd: "2026-06-30", ata: "2026-07-08", status: "CUSTOMS_CLEARED" }),
        ...
        base({ id: "shp_010", shipment_no: "SHP-KBI-2026-010", delivery_order_id: "do_010", mode: "SEA", load_type: "LCL", forwarder_id: "fwd_001", carrier_id: "carr_002", carrier: "Cheng Lie Navigation Company (CNC)", vessel_flight: "SITC SHANGHAI 116S", bl_awb_no: "BL-SHA-010", container_no: "LCL-SHA-010", pol: "CNSHA", pod: "VNHPH", etd: "2026-08-18", eta: "2026-08-26", atd: "2026-08-18", ata: "2026-08-26", status: "CUSTOMS_CLEARED" }),
        ...
        base({ id: "shp_014", shipment_no: "SHP-KBI-2026-014", delivery_order_id: "do_014", mode: "AIR", load_type: null, forwarder_id: "fwd_001", carrier_id: "carr_008", carrier: "ShunFeng Airlines", vessel_flight: "O36918", bl_awb_no: "AWB-014", container_no: null, pol: "PVG", pod: "HAN", etd: "2026-08-28", eta: "2026-08-29", atd: "2026-08-28", ata: "2026-08-29", status: "DELIVERED" }),
    ...
    // Document-type catalog: the admin-configurable required-document set (is_required)
    // that drives the DO "documents complete" gate. `code` matches DO document_type strings.
    "document-types": [
        base({ id: "doct_001", code: "Invoice", label_en: "Commercial Invoice", label_vi: "Hóa đơn thương mại", is_required: true, sort_order: 1, is_active: true }),
        base({ id: "doct_002", code: "Packing List", label_en: "Packing List", label_vi: "Phiếu đóng gói", is_required: true, sort_order: 2, is_active: true }),
        base({ id: "doct_003", code: "B/L", label_en: "Bill of Lading", label_vi: "Vận đơn", is_required: true, sort_order: 3, is_active: true }),
        base({ id: "doct_004", code: "CO", label_en: "Certificate of Origin", label_vi: "Giấy chứng nhận xuất xứ", is_required: true, sort_order: 4, is_active: true }),
        base({ id: "doct_005", code: "Fumigation Certificate", label_en: "Fumigation Certificate", label_vi: "Chứng thư hun trùng", is_required: false, sort_order: 5, is_active: true }),
        base({ id: "doct_006", code: "Insurance Certificate", label_en: "Insurance Certificate", label_vi: "Chứng nhận bảo hiểm", is_required: false, sort_order: 6, is_active: true }),
        base({ id: "doct_007", code: "Certificate of Quality", label_en: "Certificate of Quality", label_vi: "Chứng nhận chất lượng", is_required: false, sort_order: 7, is_active: true }),
        base({ id: "doct_008", code: "Debit Note", label_en: "Debit Note", label_vi: "Giấy báo nợ", is_required: false, sort_order: 8, is_active: true })
    ],
