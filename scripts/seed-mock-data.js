...
const files = {
    ...
    "delivery-orders": [
        base({ id: "do_001", delivery_order_no: "DO-KBI-2026-001", purchase_order_id: "po_002", status: "QUOTATION_CONFIRMED", requested_pickup_date: "2026-07-06", notes: "Ready for shipment creation." }),
        base({ id: "do_002", delivery_order_no: "DO-KBI-2026-002", purchase_order_id: "po_003", status: "SHIPPED", requested_pickup_date: "2026-06-20", notes: "Already shipped." }),
        base({ id: "do_003", delivery_order_no: "DO-KBI-2026-003", purchase_order_id: "po_001", status: "CANCELLED", requested_pickup_date: "2026-06-30", notes: "Historical cancelled DO.", is_delete: true, delete_at: "2026-06-11T00:00:00.000Z" }),
        base({ id: "do_004", delivery_order_no: "DO-KBI-2026-004", purchase_order_id: "po_004", status: "ASSIGNED_TO_SHIPMENT", requested_pickup_date: "2026-07-15", notes: "Partial oil filter release assigned to domestic trucking." }),
        base({ id: "do_005", delivery_order_no: "DO-KBI-2026-005", purchase_order_id: "po_005", status: "ASSIGNED_TO_SHIPMENT", requested_pickup_date: "2026-07-20", notes: "Turbocharger pickup booked with forwarder." }),
        base({ id: "do_006", delivery_order_no: "DO-KBI-2026-006", purchase_order_id: "po_006", status: "ASSIGNED_TO_SHIPMENT", requested_pickup_date: "2026-08-02", notes: "Air cargo pickup confirmed from Shanghai warehouse." }),
        base({ id: "do_007", delivery_order_no: "DO-KBI-2026-007", purchase_order_id: "po_007", status: "SHIPPED", requested_pickup_date: "2026-06-28", notes: "LCL cargo already shipped." }),
        base({ id: "do_008", delivery_order_no: "DO-KBI-2026-008", purchase_order_id: "po_008", status: "ASSIGNED_TO_SHIPMENT", requested_pickup_date: "2026-07-12", notes: "Seal kits collected for FCL consolidation." }),
        base({ id: "do_009", delivery_order_no: "DO-KBI-2026-009", purchase_order_id: "po_009", status: "SHIPPED", requested_pickup_date: "2026-08-10", notes: "Cross-border truck has departed supplier." }),
        base({ id: "do_010", delivery_order_no: "DO-KBI-2026-010", purchase_order_id: "po_010", status: "SHIPPED", requested_pickup_date: "2026-08-15", notes: "Gasket kit LCL cargo collected from supplier warehouse." }),
        base({ id: "do_011", delivery_order_no: "DO-KBI-2026-011", purchase_order_id: "po_011", status: "ASSIGNED_TO_SHIPMENT", requested_pickup_date: "2026-09-01", notes: "Starter motors assigned to urgent air shipment." }),
        base({ id: "do_012", delivery_order_no: "DO-KBI-2026-012", purchase_order_id: "po_012", status: "ASSIGNED_TO_SHIPMENT", requested_pickup_date: "2026-09-05", notes: "Breakbulk pickup requires truck with side loading." }),
