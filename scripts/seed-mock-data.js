...
const files = {
    ...
    "shipments": [
        base({ id: "shp_001", shipment_no: "SHP-KBI-2026-001", delivery_order_id: "do_001", mode: "SEA", load_type: "FCL", forwarder_id: "fwd_001", carrier_id: "carr_003", carrier: "COSCO", vessel_flight: "COSCO STAR 126E", bl_awb_no: "BL-SHA-001", container_no: "CBHU1234567", pol: "CNSHA", pod: "VNHPH", etd: "2026-07-08", eta: "2026-07-16", atd: null, ata: null, status: "BOOKING_CONFIRMED" }),
        base({ id: "shp_002", shipment_no: "SHP-KBI-2026-002", delivery_order_id: "do_002", mode: "SEA", load_type: "LCL", forwarder_id: "fwd_001", carrier_id: "carr_001", carrier: "OOCL", vessel_flight: "OOCL ASIA 021S", bl_awb_no: "BL-SHA-002", container_no: "LCL-SHA-002", pol: "CNSHA", pod: "VNHPH", etd: "2026-06-24", eta: "2026-07-02", atd: "2026-06-24", ata: null, status: "CUSTOMS_CLEARED" }),
        base({ id: "shp_003", shipment_no: "SHP-KBI-2026-003", delivery_order_id: "do_002", mode: "AIR", load_type: null, forwarder_id: "fwd_001", carrier_id: "carr_010", carrier: "VN Cargo", vessel_flight: "VN996", bl_awb_no: "AWB-003", container_no: null, pol: "PVG", pod: "HAN", etd: "2026-06-26", eta: "2026-06-27", atd: "2026-06-26", ata: "2026-06-27", status: "DELIVERED" }),
        base({ id: "shp_004", shipment_no: "SHP-KBI-2026-004", delivery_order_id: "do_004", mode: "TRUCKING", load_type: "FTL", forwarder_id: "fwd_001", carrier_id: null, carrier: "VN Trucking", vessel_flight: null, bl_awb_no: null, container_no: "TRUCK-004", pol: "Hai Phong", pod: "Kim Binh", etd: "2026-07-20", eta: "2026-07-21", atd: null, ata: null, status: "BOOKING_CONFIRMED" }),
        base({ id: "shp_005", shipment_no: "SHP-KBI-2026-005", delivery_order_id: "do_005", mode: "SEA", load_type: "FCL", forwarder_id: "fwd_001", carrier_id: "carr_006", carrier: "MAERSK", vessel_flight: "MAERSK NANSHA 241S", bl_awb_no: "BL-SHA-005", container_no: "MSKU7654321", pol: "CNSHA", pod: "VNHPH", etd: "2026-07-22", eta: "2026-07-30", atd: null, ata: null, status: "CUSTOMS_CLEARED" }),
        base({ id: "shp_006", shipment_no: "SHP-KBI-2026-006", delivery_order_id: "do_006", mode: "AIR", load_type: null, forwarder_id: "fwd_001", carrier_id: "carr_010", carrier: "Cathay Cargo", vessel_flight: "CX052", bl_awb_no: "AWB-006", container_no: null, pol: "PVG", pod: "HAN", etd: "2026-08-04", eta: "2026-08-05", atd: "2026-08-04", ata: null, status: "ATD" }),
        base({ id: "shp_007", shipment_no: "SHP-KBI-2026-007", delivery_order_id: "do_007", mode: "SEA", load_type: "LCL", forwarder_id: "fwd_001", carrier_id: "carr_001", carrier: "SITC", vessel_flight: "SITC HAIPHONG 088S", bl_awb_no: "BL-NGB-007", container_no: "LCL-NGB-007", pol: "CNNGB", pod: "VNHPH", etd: "2026-06-30", eta: "2026-07-08", atd: "2026-06-30", ata: "2026-07-08", status: "CUSTOMS_CLEARED" }),
        base({ id: "shp_008", shipment_no: "SHP-KBI-2026-008", delivery_order_id: "do_008", mode: "SEA", load_type: "FCL", forwarder_id: "fwd_001", carrier_id: "carr_001", carrier: "ONE", vessel_flight: "ONE ORPHEUS 077S", bl_awb_no: "BL-SHA-008", container_no: "TGBU9876543", pol: "CNSHA", pod: "VNHPH", etd: "2026-07-14", eta: "2026-07-22", atd: "2026-07-14", ata: null, status: "ARRIVAL_NOTICE" }),
        base({ id: "shp_009", shipment_no: "SHP-KBI-2026-009", delivery_order_id: "do_009", mode: "TRUCKING", load_type: "FTL", forwarder_id: "fwd_001", carrier_id: null, carrier: "VN Cross Border Trucking", vessel_flight: null, bl_awb_no: "CMR-CB-009", container_no: "TRUCK-CB-009", pol: "Pingxiang Border", pod: "Kim Binh", etd: "2026-08-12", eta: "2026-08-14", atd: "2026-08-12", ata: "2026-08-14", status: "DELIVERED" }),
        base({ id: "shp_010", shipment_no: "SHP-KBI-2026-010", delivery_order_id: "do_010", mode: "SEA", load_type: "LCL", forwarder_id: "fwd_001", carrier_id: "carr_001", carrier: "SITC", vessel_flight: "SITC SHANGHAI 116S", bl_awb_no: "BL-SHA-010", container_no: "LCL-SHA-010", pol: "CNSHA", pod: "VNHPH", etd: "2026-08-18", eta: "2026-08-26", atd: "2026-08-18", ata: "2026-08-26", status: "CUSTOMS_CLEARED" }),
        base({ id: "shp_011", shipment_no: "SHP-KBI-2026-011", delivery_order_id: "do_011", mode: "AIR", load_type: null, forwarder_id: "fwd_001", carrier_id: "carr_010", carrier: "China Eastern Cargo", vessel_flight: "MU7711", bl_awb_no: "AWB-011", container_no: null, pol: "PVG", pod: "HAN", etd: "2026-09-03", eta: "2026-09-04", atd: "2026-09-03", ata: null, status: "ATD" }),
        base({ id: "shp_012", shipment_no: "SHP-KBI-2026-012", delivery_order_id: "do_012", mode: "SEA", load_type: null, forwarder_id: "fwd_001", carrier_id: "carr_003", carrier: "COSCO", vessel_flight: "COSCO HEAVY 031S", bl_awb_no: "BBL-SHA-012", container_no: null, pol: "CNSHA", pod: "VNHPH", etd: "2026-09-08", eta: "2026-09-18", atd: null, ata: null, status: "BOOKING_CONFIRMED" }),
        base({ id: "shp_013", shipment_no: "SHP-KBI-2026-013", delivery_order_id: "do_013", mode: "SEA", load_type: "FCL", forwarder_id: "fwd_001", carrier_id: "carr_006", carrier: "MAERSK", vessel_flight: "MAERSK SHANGHAI 193S", bl_awb_no: "BL-SHA-013", container_no: "MRKU2468135", pol: "CNSHA", pod: "VNHPH", etd: "2026-08-05", eta: "2026-08-13", atd: "2026-08-05", ata: "2026-08-13", status: "DELIVERED" }),
        base({ id: "shp_014", shipment_no: "SHP-KBI-2026-014", delivery_order_id: "do_014", mode: "AIR", load_type: null, forwarder_id: "fwd_001", carrier_id: "carr_008", carrier: "SF Airlines", vessel_flight: "O36918", bl_awb_no: "AWB-014", container_no: null, pol: "PVG", pod: "HAN", etd: "2026-08-28", eta: "2026-08-29", atd: "2026-08-28", ata: "2026-08-29", status: "DELIVERED" })
    ],
    "shipment-lines": [
