...
const files = {
    ...
    "task-templates": [
        base({ id: "tt_001", group_code: "GR1", group_name: "Báo giá & Xác nhận dịch vụ", task_name: "Tiếp nhận yêu cầu báo giá từ KBI", task_description: "KBI gửi yêu cầu qua email. FDS Sales kiểm tra đủ thông tin: loại hàng, HS code, trọng lượng/kích thước, tuyến đường, Incoterm yêu cầu, thời gian ETD dự kiến.", milestone_code: "PRE_SHIPMENT", sla_hours: 4, sla_text: null, department: "FDS_SALES", assignee_code: "S01", related_documents: "—", note: "Assignees: S01 / S02. SOP §4 — Giai đoạn Báo giá", is_required_for_closure: false, sort_order: 1 }),
        base({ id: "tt_002", group_code: "GR1", group_name: "Báo giá & Xác nhận dịch vụ", task_name: "Chuẩn bị & gửi báo giá (Quotation)", task_description: "FDS Sales tính giá dựa trên route, mode, cargo type. Áp dụng nguyên tắc giá trucking §5 (36% cơ cấu xăng dầu). Gửi báo giá qua email chính thức. Giá cố định trừ các TH phát sinh theo SOP.", milestone_code: "PRE_SHIPMENT", sla_hours: null, sla_text: "Trước ngày hàng hàng đi 2 ngày", department: "FDS_SALES", assignee_code: "S01", related_documents: "Quotation email", note: "Assignees: S01 / S02 → S03 review. SOP §2, §5", is_required_for_closure: false, sort_order: 2 }),
        base({ id: "tt_003", group_code: "GR1", group_name: "Báo giá & Xác nhận dịch vụ", task_name: "Xác nhận dịch vụ & bàn giao Ops", task_description: "KBI xác nhận báo giá qua email. FDS Sales làm Handover note cho FDS Ops, ghi rõ: thông tin hàng, route, ETD/ETA dự kiến, yêu cầu đặc biệt, NCC liên quan.", milestone_code: "PRE_SHIPMENT", sla_hours: null, sla_text: "Trước ngày hàng hàng đi 1 ngày", department: "FDS_SALES", assignee_code: "S01", related_documents: "Handover note, Booking request", note: "Assignees: S01/S02 → O03. SOP §3 — Bàn giao Ops", is_required_for_closure: false, sort_order: 3 }),
        base({ id: "tt_004", group_code: "GR2", group_name: "Tạo & Quản lý PO", task_name: "Tạo PO trên hệ thống", task_description: "KBI tạo PO từ thông tin: supplier, item list, qty, unit price, currency, Incoterm, payment term, expected ETD. Gắn mode: SEA / AIR.", milestone_code: "PRE_SHIPMENT", sla_hours: 2, sla_text: null, department: "KBI_PURCHASING", assignee_code: null, related_documents: "PO document", note: "Assignees: (KBI – bổ sung sau). Phase 1 – PO module", is_required_for_closure: false, sort_order: 4 }),
        base({ id: "tt_005", group_code: "GR2", group_name: "Tạo & Quản lý PO", task_name: "Gửi PO & theo dõi xác nhận NCC", task_description: "PO được gửi cho NCC qua email (kèm file PDF). Theo dõi phản hồi xác nhận từ NCC (Confirmed). Cập nhật trạng thái PO trên hệ thống.", milestone_code: "PRE_SHIPMENT", sla_hours: 48, sla_text: null, department: "KBI_PURCHASING", assignee_code: null, related_documents: "PO signed/confirmed by supplier", note: "Assignees: (KBI – bổ sung sau)", is_required_for_closure: false, sort_order: 5 }),
        base({ id: "tt_006", group_code: "GR2", group_name: "Tạo & Quản lý PO", task_name: "Cập nhật trạng thái PO theo tiến độ NCC", task_description: "Theo dõi và cập nhật trạng thái PO: In-Production → Ready-to-Ship. Nếu NCC thông báo thay đổi ETD → cập nhật hệ thống và thông báo FDS Sales.", milestone_code: "PRE_SHIPMENT", sla_hours: 24, sla_text: null, department: "KBI_PURCHASING", assignee_code: null, related_documents: "NCC production update", note: "Assignees: (KBI – bổ sung sau)", is_required_for_closure: false, sort_order: 6 }),
        base({ id: "tt_007", group_code: "GR3", group_name: "Booking & Chuẩn bị hàng", task_name: "Booking tàu/chuyến bay với Carrier", task_description: "FDS Ops tiến hành booking với Carrier (hãng tàu/bay) theo route và ETD yêu cầu. Xác nhận booking number, vessel name hoặc flight number.", milestone_code: "MS1_BOOKING_CONFIRMED", sla_hours: 24, sla_text: null, department: "FDS_OPS", assignee_code: "O01", related_documents: "Booking confirmation", note: "Assignees: O01 / O02", is_required_for_closure: true, sort_order: 7 }),
        base({ id: "tt_008", group_code: "GR3", group_name: "Booking & Chuẩn bị hàng", task_name: "Thông báo Cargo Ready & kiểm tra hàng tại origin", task_description: "NCC thông báo hàng ready tại điểm xuất. FDS Ops / Agent xác nhận cargo condition, số kiện, trọng lượng, thể tích. Chụp ảnh nếu cần.", milestone_code: "MS2_CARGO_READY", sla_hours: 8, sla_text: null, department: "FDS_OPS", assignee_code: "O01", related_documents: "Cargo ready notice, Packing List draft", note: "Assignees: O01", is_required_for_closure: true, sort_order: 8 }),
        base({ id: "tt_009", group_code: "GR4", group_name: "Vận chuyển & Tracking", task_name: "Xác nhận hàng đã lên tàu / máy bay (Loaded)", task_description: "FDS Ops xác nhận Onboard confirmation từ Carrier. Cập nhật ATD thực tế, tên vessel/flight, voyage/flight number lên hệ thống. Thông báo KBI.", milestone_code: "MS3_LOADED", sla_hours: 4, sla_text: null, department: "FDS_OPS", assignee_code: "O01", related_documents: "Onboard B/L draft, Flight confirmation", note: "Assignees: O01", is_required_for_closure: true, sort_order: 9 }),
        base({ id: "tt_010", group_code: "GR4", group_name: "Vận chuyển & Tracking", task_name: "Theo dõi in-transit & cập nhật ETA", task_description: "FDS Ops cập nhật trạng thái in-transit định kỳ (mỗi 2 ngày với SEA, hàng ngày với AIR). Cập nhật ETA nếu có thay đổi, thông báo KBI qua email.", milestone_code: "MS4_IN_TRANSIT", sla_hours: 48, sla_text: null, department: "FDS_OPS", assignee_code: "O01", related_documents: "Tracking updates", note: "Assignees: O01 / O03. SOP §2 — thông báo qua email", is_required_for_closure: true, sort_order: 10 }),
        base({ id: "tt_011", group_code: "GR4", group_name: "Vận chuyển & Tracking", task_name: "Gửi Draft B/L hoặc Draft AWB cho KBI", task_description: "FDS Ops nhận Draft B/L (SEA) hoặc Draft AWB (AIR) từ Carrier. Gửi cho KBI kiểm tra thông tin: shipper, consignee, notify party, description of goods, HS code, weight, measure.", milestone_code: "MS3_LOADED", sla_hours: 24, sla_text: null, department: "FDS_OPS", assignee_code: "O02", related_documents: "Draft B/L / Draft AWB", note: "Assignees: O02 / O01. SOP §3 — FDS Ops xử lý chứng từ", is_required_for_closure: true, sort_order: 11 }),
        base({ id: "tt_012", group_code: "GR4", group_name: "Vận chuyển & Tracking", task_name: "KBI xác nhận / yêu cầu chỉnh sửa Draft B/L hoặc AWB", task_description: "KBI kiểm tra Draft B/L / AWB và phản hồi trong vòng SLA. Nếu có chỉnh sửa: ghi rõ nội dung cần sửa qua email, FDS Ops phối hợp Carrier sửa và gửi lại Draft để KBI re-confirm trước khi phát hành Final.", milestone_code: "MS5_ARRIVED_PORT", sla_hours: 24, sla_text: null, department: "KBI_PURCHASING", assignee_code: null, related_documents: "Draft B/L confirmation email", note: "Assignees: (KBI – bổ sung sau)", is_required_for_closure: true, sort_order: 12 }),
        base({ id: "tt_013", group_code: "GR5", group_name: "Thông quan (Customs)", task_name: "Chuẩn bị hồ sơ thông quan", task_description: "FDS Ops (O02 – Custom & Docs Manager) tổng hợp bộ chứng từ: Commercial Invoice, Packing List, B/L gốc hoặc Telex Release, C/O (nếu có), Catalogue/datasheet nếu hải quan yêu cầu.", milestone_code: "MS5_ARRIVED_PORT", sla_hours: 8, sla_text: null, department: "FDS_OPS_CUSTOMS", assignee_code: "O02", related_documents: "Invoice, Packing List, B/L, C/O", note: "Assignees: O02", is_required_for_closure: true, sort_order: 13 }),
        base({ id: "tt_014", group_code: "GR5", group_name: "Thông quan (Customs)", task_name: "Nộp tờ khai hải quan (Customs Declaration)", task_description: "FDS Ops nộp tờ khai VNACCS (thường qua đại lý hải quan). Ghi nhận số tờ khai, ngày nộp, loại luồng (xanh/vàng/đỏ). Cập nhật milestone lên hệ thống.", milestone_code: "MS6_CUSTOMS_SUBMITTED", sla_hours: 4, sla_text: null, department: "FDS_OPS_CUSTOMS", assignee_code: "O02", related_documents: "Customs declaration form", note: "Assignees: O02", is_required_for_closure: true, sort_order: 14 }),
        base({ id: "tt_015", group_code: "GR5", group_name: "Thông quan (Customs)", task_name: "Theo dõi & hoàn tất thông quan", task_description: "Theo dõi kết quả phân luồng. Phối hợp xử lý nếu luồng vàng/đỏ (cung cấp thêm chứng từ, giải trình). Xác nhận Customs Cleared. Thông báo KBI và cập nhật hệ thống.", milestone_code: "MS7_CUSTOMS_CLEARED", sla_hours: 24, sla_text: null, department: "FDS_OPS_CUSTOMS", assignee_code: "O02", related_documents: "Customs release order", note: "Assignees: O02 / O03. Phát sinh chi phí: SOP §2", is_required_for_closure: true, sort_order: 15 }),
        base({ id: "tt_016", group_code: "GR6", group_name: "Giao nhận & Kho", task_name: "Vận chuyển trucking từ cảng về kho KBI", task_description: "FDS Ops điều phối xe tải (trucking) lấy hàng tại cảng sau khi thông quan. Báo giá trucking theo nguyên tắc SOP §5 (update giá dầu ngày giao hàng nếu biến động). Xác nhận lịch giao với KBI.", milestone_code: "MS7_CUSTOMS_CLEARED", sla_hours: 8, sla_text: null, department: "FDS_OPS", assignee_code: "O01", related_documents: "Delivery order, Truck booking", note: "Assignees: O01 / O03. SOP §5 — điều chỉnh giá xăng dầu", is_required_for_closure: true, sort_order: 16 }),
        base({ id: "tt_017", group_code: "GR6", group_name: "Giao nhận & Kho", task_name: "Giao hàng tại cổng kho KBI (Gate-in)", task_description: "Xe tải đến kho KBI. Ghi nhận ATA thực tế. KBI kiểm đếm số kiện, kiểm tra tình trạng hàng hóa. Ký xác nhận giao nhận. Cập nhật milestone MS-8 lên hệ thống.", milestone_code: "MS8_DELIVERED_GATE", sla_hours: 2, sla_text: null, department: "FDS_OPS", assignee_code: "O01", related_documents: "Delivery receipt / Biên bản giao nhận", note: "Assignees: O01 + (KBI – bổ sung sau)", is_required_for_closure: true, sort_order: 17 }),
        base({ id: "tt_018", group_code: "GR7", group_name: "Chứng từ hoàn chỉnh", task_name: "Thu thập & gửi bộ chứng từ gốc cho KBI", task_description: "FDS Ops tập hợp bộ chứng từ hoàn chỉnh sau khi hàng về kho: Original B/L hoặc Seaway Bill, Final Invoice, Packing List, C/O gốc, Customs Declaration cleared, Debit Note. Gửi cho KBI qua email hoặc courier.", milestone_code: "MS8_DELIVERED_GATE", sla_hours: 48, sla_text: null, department: "FDS_OPS", assignee_code: "O02", related_documents: "Full document set", note: "Assignees: O02 / O01. SOP §3 — FDS Ops hoàn tất hồ sơ", is_required_for_closure: true, sort_order: 18 }),
        base({ id: "tt_019", group_code: "GR8", group_name: "Công nợ & Hóa đơn", task_name: "Phát hành Debit Note / Hóa đơn dịch vụ", task_description: "FDS Kế toán tổng hợp chi phí phát sinh theo lô hàng: cước biển/hàng không, phí local, phí thông quan, trucking. Phát hành Debit Note gửi KBI qua email kế toán.", milestone_code: "MS8_DELIVERED_GATE", sla_hours: 48, sla_text: null, department: "FDS_ACCOUNTING", assignee_code: "A01", related_documents: "Debit Note, Tax invoice", note: "Assignees: A01 / A02. SOP §3 — FDS Kế toán", is_required_for_closure: false, sort_order: 19 }),
        base({ id: "tt_020", group_code: "GR8", group_name: "Công nợ & Hóa đơn", task_name: "Đối chiếu công nợ & xác nhận thanh toán", task_description: "KBI đối chiếu Debit Note với báo giá ban đầu. Nếu có chênh lệch: KBI email yêu cầu giải trình → FDS Kế toán / Sales phối hợp giải quyết. Xác nhận thanh toán và lưu hồ sơ.", milestone_code: null, sla_hours: 72, sla_text: null, department: "FDS_ACCOUNTING", assignee_code: "A02", related_documents: "Payment confirmation, Bank transfer slip", note: "Assignees: A02 + (KBI – bổ sung sau). SOP §3, §6", is_required_for_closure: false, sort_order: 20 })
    ],
    "purchase-orders": [
        // Supplier spread + deliberate schedule deviation so the dashboard supplier
        // leaderboard has a real field to compare. Each alias has a distinct profile:
        //   sup_sdec ~12d lead / always on time      sup_choho     ~9d  / always on time
        //   sup_shanghai_oem ~15d / mostly on time   sup_naibo     ~20d / sometimes late
        //   sup_kowei ~33d / always late             sup_pairgears ~35d / very late
        base({ id: "po_001", po_no: "PO-KBI-2026-001", supplier_id: "sup_sdec", po_type: "IMPORT", incoterm_id: "inc_fob", payment_term: "30% deposit, 70% before shipment", currency_code: "USD", exchange_rate: 25000, status: "CONFIRMED", confirmed_at: "2026-06-21T03:00:00.000Z", expected_etd: "2026-07-03", expected_eta: "2026-07-10", actual_etd: "2026-07-03", actual_warehouse_ata: "2026-07-10T09:00:00.000Z", origin_port: "Fuzhou Port", destination_port: "Cat Lai Port", notes: "Multi-item split LOT demo PO for drag/drop testing." }),
        base({ id: "po_002", po_no: "PO-KBI-2026-002", supplier_id: "sup_shanghai_oem", po_type: "IMPORT", incoterm_id: "inc_cfr", payment_term: "Net 30", currency_code: "USD", exchange_rate: 25000, status: "READY_TO_SHIP", confirmed_at: "2026-06-23T03:00:00.000Z", expected_etd: "2026-07-08", expected_eta: "2026-07-16", actual_etd: "2026-07-08", actual_warehouse_ata: "2026-07-16T09:00:00.000Z", origin_port: "Shanghai Port", destination_port: "Cat Lai Port", notes: "Ready cargo from Shanghai OEM." }),
        base({ id: "po_003", po_no: "PO-KBI-2026-003", supplier_id: "sup_kowei", po_type: "IMPORT", incoterm_id: "inc_fob", payment_term: "LC at sight", currency_code: "USD", exchange_rate: 25000, status: "SHIPPED", confirmed_at: "2026-05-27T03:00:00.000Z", expected_etd: "2026-06-24", expected_eta: "2026-07-02", actual_etd: "2026-06-29", actual_warehouse_ata: "2026-07-07T09:00:00.000Z", origin_port: "Fuzhou Port", destination_port: "Cat Lai Port", notes: "Shipped 5 days behind the promised ETD." }),
        base({ id: "po_004", po_no: "PO-KBI-2026-004", supplier_id: "sup_choho", po_type: "IMPORT", incoterm_id: "inc_exw", payment_term: "Net 45", currency_code: "CNY", exchange_rate: 3500, status: "CONFIRMED", confirmed_at: "2026-07-09T03:00:00.000Z", expected_etd: "2026-07-18", expected_eta: "2026-07-26", actual_etd: "2026-07-18", actual_warehouse_ata: "2026-07-26T09:00:00.000Z", origin_port: "Pingxiang Border Gate", destination_port: "Huu Nghi Border Gate", notes: "Confirmed, pending LOT planning." }),
        base({ id: "po_005", po_no: "PO-KBI-2026-005", supplier_id: "sup_sdec", po_type: "IMPORT", incoterm_id: "inc_fob", payment_term: "30% deposit, balance before ETD", currency_code: "USD", exchange_rate: 25000, status: "READY_TO_SHIP", confirmed_at: "2026-07-10T03:00:00.000Z", expected_etd: "2026-07-22", expected_eta: "2026-07-30", actual_etd: "2026-07-22", actual_warehouse_ata: "2026-07-30T09:00:00.000Z", origin_port: "Fuzhou Port", destination_port: "Cat Lai Port", notes: "Urgent turbocharger replenishment for service stock." }),
        base({ id: "po_006", po_no: "PO-KBI-2026-006", supplier_id: "sup_naibo", po_type: "IMPORT", incoterm_id: "inc_exw", payment_term: "Net 45 after invoice", currency_code: "CNY", exchange_rate: 3500, status: "CONFIRMED", confirmed_at: "2026-07-15T03:00:00.000Z", expected_etd: "2026-08-04", expected_eta: "2026-08-05", actual_etd: "2026-08-07", actual_warehouse_ata: "2026-08-08T09:00:00.000Z", origin_port: "Shanghai Pudong Airport", destination_port: "Tan Son Nhat Airport", notes: "Air freight for alternator shortage; released 3 days late." }),
        base({ id: "po_007", po_no: "PO-KBI-2026-007", supplier_id: "sup_kowei", po_type: "IMPORT", incoterm_id: "inc_cfr", payment_term: "LC at sight", currency_code: "USD", exchange_rate: 25000, status: "SHIPPED", confirmed_at: "2026-06-02T03:00:00.000Z", expected_etd: "2026-06-30", expected_eta: "2026-07-08", actual_etd: "2026-07-06", actual_warehouse_ata: "2026-07-14T09:00:00.000Z", origin_port: "Fuzhou Port", destination_port: "Cat Lai Port", notes: "Fuel injector shipment left 6 days behind schedule." }),
        base({ id: "po_008", po_no: "PO-KBI-2026-008", supplier_id: "sup_shanghai_oem", po_type: "IMPORT", incoterm_id: "inc_fob", payment_term: "Net 30", currency_code: "USD", exchange_rate: 25000, status: "READY_TO_SHIP", confirmed_at: "2026-06-29T03:00:00.000Z", expected_etd: "2026-07-14", expected_eta: "2026-07-22", actual_etd: "2026-07-16", actual_warehouse_ata: "2026-07-24T09:00:00.000Z", origin_port: "Shanghai Port", destination_port: "Hai Phong Port", notes: "Hydraulic seal kits slipped 2 days at origin." }),
        base({ id: "po_009", po_no: "PO-KBI-2026-009", supplier_id: "sup_choho", po_type: "IMPORT", incoterm_id: "inc_cfr", payment_term: "20% deposit, 80% against BL copy", currency_code: "USD", exchange_rate: 25000, status: "CONFIRMED", confirmed_at: "2026-08-03T03:00:00.000Z", expected_etd: "2026-08-12", expected_eta: "2026-08-14", actual_etd: "2026-08-12", actual_warehouse_ata: "2026-08-14T09:00:00.000Z", origin_port: "Pingxiang Border Gate", destination_port: "Huu Nghi Border Gate", notes: "Cross-border trucking option for radiator assemblies." }),
        base({ id: "po_010", po_no: "PO-KBI-2026-010", supplier_id: "sup_pairgears", po_type: "IMPORT", incoterm_id: "inc_fob", payment_term: "30% deposit, balance before vessel departure", currency_code: "USD", exchange_rate: 25000, status: "SHIPPED", confirmed_at: "2026-07-14T03:00:00.000Z", expected_etd: "2026-08-18", expected_eta: "2026-08-26", actual_etd: "2026-08-25", actual_warehouse_ata: "2026-09-02T09:00:00.000Z", notes: "Gasket kits shipped by LCL, 7 days late out of the factory." }),
        base({ id: "po_011", po_no: "PO-KBI-2026-011", supplier_id: "sup_naibo", po_type: "IMPORT", incoterm_id: "inc_exw", payment_term: "Net 30 after pickup confirmation", currency_code: "CNY", exchange_rate: 3500, status: "CONFIRMED", confirmed_at: "2026-08-14T03:00:00.000Z", expected_etd: "2026-09-03", expected_eta: "2026-09-04", actual_etd: "2026-09-03", actual_warehouse_ata: "2026-09-04T09:00:00.000Z", notes: "Starter motors moved by air due to urgent service demand." }),
        base({ id: "po_012", po_no: "PO-KBI-2026-012", supplier_id: "sup_sdec", po_type: "IMPORT", incoterm_id: "inc_fob", payment_term: "LC at sight", currency_code: "USD", exchange_rate: 25000, status: "READY_TO_SHIP", confirmed_at: "2026-08-27T03:00:00.000Z", expected_etd: "2026-09-08", expected_eta: "2026-09-18", actual_etd: "2026-09-08", actual_warehouse_ata: "2026-09-18T09:00:00.000Z", notes: "Oversized hydraulic hose assemblies booked as breakbulk." }),
        base({ id: "po_013", po_no: "PO-KBI-2026-013", supplier_id: "sup_shanghai_oem", po_type: "IMPORT", incoterm_id: "inc_cfr", payment_term: "Net 45", currency_code: "USD", exchange_rate: 25000, status: "SHIPPED", confirmed_at: "2026-07-21T03:00:00.000Z", expected_etd: "2026-08-05", expected_eta: "2026-08-13", actual_etd: "2026-08-05", actual_warehouse_ata: "2026-08-13T09:00:00.000Z", notes: "Fuel water separator filters delivered to replenish maintenance stock." }),
        base({ id: "po_014", po_no: "PO-KBI-2026-014", supplier_id: "sup_kowei", po_type: "IMPORT", incoterm_id: "inc_exw", payment_term: "50% deposit, 50% after QC release", currency_code: "USD", exchange_rate: 25000, status: "SHIPPED", confirmed_at: "2026-07-31T03:00:00.000Z", expected_etd: "2026-08-28", expected_eta: "2026-08-29", actual_etd: "2026-09-01", actual_warehouse_ata: "2026-09-02T09:00:00.000Z", notes: "ECU modules held 4 extra days for QC release." }),
        base({ id: "po_015", po_no: "PO-KBI-2026-015", supplier_id: "sup_sdec", po_type: "IMPORT", incoterm_id: "inc_fob", payment_term: "30% deposit, 70% before shipment", currency_code: "USD", exchange_rate: 25000, quotation_id: "qt_025", status: "CONFIRMED", confirmed_at: "2026-07-18T03:00:00.000Z", expected_etd: "2026-07-30", expected_eta: "2026-08-07", actual_etd: "2026-07-30", actual_warehouse_ata: "2026-08-07T09:00:00.000Z", origin_port: "Fuzhou Port", destination_port: "Cat Lai Port", notes: "Reversed-flow golden chain: created from confirmed quotation qt_025." }),
        base({ id: "po_016", po_no: "PO-KBI-2026-016", supplier_id: "sup_shanghai_oem", po_type: "IMPORT", incoterm_id: "inc_fob", payment_term: "Net 30", currency_code: "USD", exchange_rate: 25000, status: "CONFIRMED", confirmed_at: "2026-07-28T03:00:00.000Z", expected_etd: "2026-08-12", expected_eta: "2026-08-18", actual_etd: "2026-08-12", actual_warehouse_ata: "2026-08-18T09:00:00.000Z", origin_port: "Shanghai Port", destination_port: "Cat Lai Port", notes: "Backs early-stage DO demo (draft/created/ready/quotation-confirmed)." }),
        base({ id: "po_017", po_no: "PO-KBI-2026-017", supplier_id: "sup_choho", po_type: "IMPORT", incoterm_id: "inc_fob", payment_term: "Net 30", currency_code: "USD", exchange_rate: 25000, status: "CONFIRMED", confirmed_at: "2026-08-05T03:00:00.000Z", expected_etd: "2026-08-14", expected_eta: "2026-08-20", actual_etd: "2026-08-14", actual_warehouse_ata: "2026-08-20T09:00:00.000Z", origin_port: "Fuzhou Port", destination_port: "Cat Lai Port", notes: "Backs the visible cancelled DO demo." }),
        base({ id: "po_018", po_no: "PO-KBI-2026-018", supplier_id: "sup_pairgears", po_type: "IMPORT", incoterm_id: "inc_cfr", payment_term: "Net 45", currency_code: "USD", exchange_rate: 25000, status: "SHIPPED", confirmed_at: "2026-06-17T03:00:00.000Z", expected_etd: "2026-07-22", expected_eta: "2026-07-28", actual_etd: "2026-07-29", actual_warehouse_ata: "2026-08-04T09:00:00.000Z", origin_port: "Shanghai Port", destination_port: "Cat Lai Port", notes: "Warehouse-pending DO demo; factory released 7 days late." }),
        base({ id: "po_019", po_no: "PO-KBI-2026-019", supplier_id: "sup_naibo", po_type: "IMPORT", incoterm_id: "inc_fob", payment_term: "LC at sight", currency_code: "USD", exchange_rate: 25000, status: "SHIPPED", confirmed_at: "2026-06-26T03:00:00.000Z", expected_etd: "2026-07-16", expected_eta: "2026-07-22", actual_etd: "2026-07-16", actual_warehouse_ata: "2026-07-22T09:00:00.000Z", origin_port: "Shanghai Port", destination_port: "Hai Phong Port", notes: "Backs the customs-processing DO demo (linked shipment in customs draft)." })
    ],
    "purchase-order-lines": [
        ...
        base({ id: "po_line_018", purchase_order_id: "po_015", item_id: "item_001", line_no: 1, qty_ordered: 20, unit: "PCS", unit_price: 8200, tax_rate: 10, discount_pct: 0, sort_order: 1 }),
        base({ id: "po_line_019", purchase_order_id: "po_016", item_id: "item_003", line_no: 1, qty_ordered: 25, unit: "SET", unit_price: 1800, tax_rate: 10, discount_pct: 0, sort_order: 1 }),
        base({ id: "po_line_020", purchase_order_id: "po_016", item_id: "item_006", line_no: 2, qty_ordered: 30, unit: "PCS", unit_price: 1850, tax_rate: 10, discount_pct: 0, sort_order: 2 }),
        base({ id: "po_line_021", purchase_order_id: "po_016", item_id: "item_007", line_no: 3, qty_ordered: 240, unit: "SET", unit_price: 38, tax_rate: 10, discount_pct: 0, sort_order: 3 }),
        base({ id: "po_line_022", purchase_order_id: "po_016", item_id: "item_010", line_no: 4, qty_ordered: 120, unit: "KIT", unit_price: 32, tax_rate: 10, discount_pct: 0, sort_order: 4 }),
        base({ id: "po_line_023", purchase_order_id: "po_017", item_id: "item_004", line_no: 1, qty_ordered: 10, unit: "PCS", unit_price: 1200, tax_rate: 10, discount_pct: 0, sort_order: 1 }),
        base({ id: "po_line_024", purchase_order_id: "po_018", item_id: "item_013", line_no: 1, qty_ordered: 600, unit: "PCS", unit_price: 9.2, tax_rate: 10, discount_pct: 0, sort_order: 1 }),
        base({ id: "po_line_025", purchase_order_id: "po_019", item_id: "item_008", line_no: 1, qty_ordered: 800, unit: "KIT", unit_price: 4.5, tax_rate: 10, discount_pct: 0, sort_order: 1 })
    ],
    ...
    "po-lots": [
        ...
        base({ id: "lot_016", purchase_order_id: "po_015", lot_no: "LOT-016", lot_name: "Golden Chain Engine Lot", status: "ASSIGNED_TO_SHIPMENT", planned_cargo_ready_date: "2026-07-28", planned_etd: "2026-07-30", planned_eta: "2026-08-07", origin_port: "Fuzhou Port", destination_port: "Cat Lai Port", sort_order: 1, notes: "Reversed-flow golden chain lot." }),
        base({ id: "lot_017", purchase_order_id: "po_016", lot_no: "LOT-017", lot_name: "Draft Stage Lot", status: "PLANNED", planned_cargo_ready_date: "2026-08-10", planned_etd: "2026-08-12", planned_eta: "2026-08-18", origin_port: "Shanghai Port", destination_port: "Cat Lai Port", sort_order: 1, notes: "Early-stage DO demo." }),
        base({ id: "lot_018", purchase_order_id: "po_016", lot_no: "LOT-018", lot_name: "Created Stage Lot", status: "PLANNED", planned_cargo_ready_date: "2026-08-10", planned_etd: "2026-08-12", planned_eta: "2026-08-18", origin_port: "Shanghai Port", destination_port: "Cat Lai Port", sort_order: 2, notes: "Early-stage DO demo." }),
        base({ id: "lot_019", purchase_order_id: "po_016", lot_no: "LOT-019", lot_name: "Ready For Quotation Lot", status: "PLANNED", planned_cargo_ready_date: "2026-08-11", planned_etd: "2026-08-13", planned_eta: "2026-08-19", origin_port: "Shanghai Port", destination_port: "Cat Lai Port", sort_order: 3, notes: "Early-stage DO demo." }),
        base({ id: "lot_020", purchase_order_id: "po_016", lot_no: "LOT-020", lot_name: "Quotation Confirmed Lot", status: "PLANNED", planned_cargo_ready_date: "2026-08-11", planned_etd: "2026-08-13", planned_eta: "2026-08-19", origin_port: "Shanghai Pudong Airport", destination_port: "Tan Son Nhat Airport", sort_order: 4, notes: "Early-stage DO demo." }),
        base({ id: "lot_021", purchase_order_id: "po_017", lot_no: "LOT-021", lot_name: "Cancelled DO Lot", status: "PLANNED", planned_cargo_ready_date: "2026-08-12", planned_etd: "2026-08-14", planned_eta: "2026-08-20", origin_port: "Fuzhou Port", destination_port: "Cat Lai Port", sort_order: 1, notes: "Backs visible cancelled DO." }),
        base({ id: "lot_022", purchase_order_id: "po_018", lot_no: "LOT-022", lot_name: "Warehouse Pending Lot", status: "SHIPPED", planned_cargo_ready_date: "2026-07-20", planned_etd: "2026-07-22", planned_eta: "2026-07-28", origin_port: "Shanghai Port", destination_port: "Cat Lai Port", sort_order: 1, notes: "Goods arrived, awaiting warehouse." }),
        base({ id: "lot_023", purchase_order_id: "po_019", lot_no: "LOT-023", lot_name: "Customs Processing Lot", status: "ASSIGNED_TO_SHIPMENT", planned_cargo_ready_date: "2026-07-14", planned_etd: "2026-07-16", planned_eta: "2026-07-22", origin_port: "Shanghai Port", destination_port: "Hai Phong Port", sort_order: 1, notes: "Linked shipment in customs draft." })
    ],
    "po-lot-lines": [
        ...
        base({ id: "lot_line_020", po_lot_id: "lot_016", purchase_order_line_id: "po_line_018", item_id: "item_001", qty_lotted: 20, unit: "PCS", sort_order: 1 }),
        base({ id: "lot_line_021", po_lot_id: "lot_017", purchase_order_line_id: "po_line_019", item_id: "item_003", qty_lotted: 25, unit: "SET", sort_order: 1 }),
        base({ id: "lot_line_022", po_lot_id: "lot_018", purchase_order_line_id: "po_line_020", item_id: "item_006", qty_lotted: 30, unit: "PCS", sort_order: 1 }),
        base({ id: "lot_line_023", po_lot_id: "lot_019", purchase_order_line_id: "po_line_021", item_id: "item_007", qty_lotted: 240, unit: "SET", sort_order: 1 }),
        base({ id: "lot_line_024", po_lot_id: "lot_020", purchase_order_line_id: "po_line_022", item_id: "item_010", qty_lotted: 120, unit: "KIT", sort_order: 1 }),
        base({ id: "lot_line_025", po_lot_id: "lot_021", purchase_order_line_id: "po_line_023", item_id: "item_004", qty_lotted: 10, unit: "PCS", sort_order: 1 }),
        base({ id: "lot_line_026", po_lot_id: "lot_022", purchase_order_line_id: "po_line_024", item_id: "item_013", qty_lotted: 600, unit: "PCS", sort_order: 1 }),
        base({ id: "lot_line_027", po_lot_id: "lot_023", purchase_order_line_id: "po_line_025", item_id: "item_008", qty_lotted: 800, unit: "KIT", sort_order: 1 })
    ],
    "delivery-orders": [
        ...
        base({ id: "do_015", delivery_order_no: "DO-KBI-2026-015", purchase_order_id: "po_015", transport_mode_id: "tm_sea_fcl", status: "ASSIGNED_TO_SHIPMENT", requested_pickup_date: "2026-07-28", planned_cargo_ready_date: "2026-07-28", planned_etd: "2026-07-30", planned_eta: "2026-08-07", origin_address: "Fuzhou Port", destination_address: "CatLai Port", warehouse_name: "Kim Binh Main Warehouse", notes: "Golden chain DO from confirmed quotation qt_025 (shipment shp_015)." }),
        base({ id: "do_016", delivery_order_no: "DO-KBI-2026-016", purchase_order_id: "po_016", transport_mode_id: "tm_sea_fcl", status: "DRAFT", requested_pickup_date: "2026-08-10", planned_cargo_ready_date: "2026-08-10", planned_etd: "2026-08-12", planned_eta: "2026-08-18", origin_address: "Shanghai Port", destination_address: "CatLai Port", warehouse_name: "Kim Binh Main Warehouse", notes: "Draft DO — not yet handed to logistics." }),
        base({ id: "do_017", delivery_order_no: "DO-KBI-2026-017", purchase_order_id: "po_016", transport_mode_id: "tm_sea_fcl", status: "CREATED", requested_pickup_date: "2026-08-10", planned_cargo_ready_date: "2026-08-10", planned_etd: "2026-08-12", planned_eta: "2026-08-18", origin_address: "Shanghai Port", destination_address: "CatLai Port", warehouse_name: "Kim Binh Main Warehouse", notes: "Created DO, awaiting logistics pickup." }),
        base({ id: "do_018", delivery_order_no: "DO-KBI-2026-018", purchase_order_id: "po_016", transport_mode_id: "tm_sea_lcl", status: "READY_FOR_QUOTATION", requested_pickup_date: "2026-08-11", planned_cargo_ready_date: "2026-08-11", planned_etd: "2026-08-13", planned_eta: "2026-08-19", origin_address: "Shanghai CFS", destination_address: "CatLai Port", warehouse_name: "Kim Binh Main Warehouse", notes: "Ready for forwarder quotation." }),
        base({ id: "do_019", delivery_order_no: "DO-KBI-2026-019", purchase_order_id: "po_016", transport_mode_id: "tm_air", status: "QUOTATION_CONFIRMED", requested_pickup_date: "2026-08-11", planned_cargo_ready_date: "2026-08-11", planned_etd: "2026-08-13", planned_eta: "2026-08-14", origin_address: "Shanghai Pudong Airport", destination_address: "Tan Son Nhat Airport", warehouse_name: "Kim Binh Main Warehouse", notes: "Quotation confirmed, ready to create shipment." }),
        base({ id: "do_020", delivery_order_no: "DO-KBI-2026-020", purchase_order_id: "po_017", transport_mode_id: "tm_sea_fcl", status: "CANCELLED", requested_pickup_date: "2026-08-12", planned_cargo_ready_date: "2026-08-12", planned_etd: "2026-08-14", planned_eta: "2026-08-20", origin_address: "Fuzhou Port", destination_address: "CatLai Port", warehouse_name: "Kim Binh Main Warehouse", notes: "Cancelled DO (visible) — order withdrawn by KBI." }),
        base({ id: "do_021", delivery_order_no: "DO-KBI-2026-021", purchase_order_id: "po_018", transport_mode_id: "tm_sea_lcl", status: "WAREHOUSE_PENDING", requested_pickup_date: "2026-07-20", planned_cargo_ready_date: "2026-07-20", planned_etd: "2026-07-22", planned_eta: "2026-07-28", origin_address: "Shanghai CFS", destination_address: "CatLai Port", warehouse_name: "Kim Binh Main Warehouse", notes: "Cleared cargo waiting at warehouse gate (no active shipment)." }),
        base({ id: "do_022", delivery_order_no: "DO-KBI-2026-022", purchase_order_id: "po_019", transport_mode_id: "tm_sea_fcl", status: "ASSIGNED_TO_SHIPMENT", requested_pickup_date: "2026-07-14", planned_cargo_ready_date: "2026-07-14", planned_etd: "2026-07-16", planned_eta: "2026-07-22", origin_address: "Shanghai Port", destination_address: "Hai Phong Port", warehouse_name: "Kim Binh Main Warehouse", notes: "Customs processing demo (shipment shp_016 in customs draft)." })
    ],
    "logistics-tasks": [
        base({ task_id: "task_001", id: "task_001", do_number: "DO-KBI-2026-001", hbl_number: null, request_code: "DO-KBI-2026-001", po_number: "PO-KBI-2026-002", production_contract_number: "KBI-CN-2026-002", task_name: "Booking tàu/chuyến bay với Carrier", task_template_id: "tt_007", department: "FDS_OPS", assignee_code: "O01", assignee: { user_id: "u_ops_01", name: "Mai Anh", department: "FDS_OPS" }, progress: 40, created_at: "2026-06-08T02:00:00.000Z", assigned_at: "2026-06-08T03:00:00.000Z", completed_at: null, status: "IN_PROGRESS", priority: "HIGH", due_date: "2026-06-12", notes: "Đang chốt booking với hãng tàu để tạo shipment.", blocked_reason: null, blocked_by_party: null }),
        base({ task_id: "task_002", id: "task_002", do_number: "DO-KBI-2026-005", hbl_number: null, request_code: "DO-KBI-2026-005", po_number: "PO-KBI-2026-005", production_contract_number: "KBI-CN-2026-005", task_name: "Booking tàu Shanghai – Hải Phòng", task_template_id: "tt_007", department: "FDS_OPS", assignee_code: "O01", assignee: { user_id: "u_ops_02", name: "Hoàng Nam", department: "FDS_OPS" }, progress: 25, created_at: "2026-06-10T02:00:00.000Z", assigned_at: "2026-06-10T03:00:00.000Z", completed_at: null, status: "BLOCKED", priority: "URGENT", due_date: "2026-06-11", notes: "Booking bị giữ do NCC chưa gửi Shipping Instruction.", blocked_reason: "Chờ NCC gửi Shipping Instruction (SI).", blocked_by_party: "SUPPLIER" }),
        base({ task_id: "task_003", id: "task_003", do_number: "DO-KBI-2026-006", hbl_number: null, request_code: "DO-KBI-2026-006", po_number: "PO-KBI-2026-006", production_contract_number: "KBI-CN-2026-006", task_name: "Chuẩn bị hồ sơ thông quan (hàng air)", task_template_id: "tt_013", department: "FDS_OPS_CUSTOMS", assignee_code: "O02", assignee: { user_id: "u_cus_02", name: "Thu Hà", department: "FDS_OPS_CUSTOMS" }, progress: 65, created_at: "2026-06-11T02:00:00.000Z", assigned_at: "2026-06-11T03:00:00.000Z", completed_at: null, status: "WAITING", priority: "HIGH", due_date: "2026-06-12", notes: "Chờ đồng bộ Commercial Invoice và Packing List.", blocked_reason: null, blocked_by_party: null }),
        base({ task_id: "task_004", id: "task_004", do_number: "DO-KBI-2026-007", hbl_number: "HBL-KBI-007", request_code: "DO-KBI-2026-007", po_number: "PO-KBI-2026-007", production_contract_number: "KBI-CN-2026-007", task_name: "Nộp tờ khai hải quan (Customs Declaration)", task_template_id: "tt_014", department: "FDS_OPS_CUSTOMS", assignee_code: "O02", assignee: { user_id: "u_cus_01", name: "Quốc Bảo", department: "FDS_OPS_CUSTOMS" }, progress: 50, created_at: "2026-06-09T02:00:00.000Z", assigned_at: "2026-06-09T03:00:00.000Z", completed_at: null, status: "IN_PROGRESS", priority: "HIGH", due_date: "2026-06-12", notes: "Cần mapping HS code với Packing List trước khi nộp VNACCS.", blocked_reason: null, blocked_by_party: null }),
        base({ task_id: "task_005", id: "task_005", do_number: "DO-KBI-2026-009", hbl_number: "HBL-KBI-009", request_code: "DO-KBI-2026-009", po_number: "PO-KBI-2026-009", production_contract_number: "KBI-CN-2026-009", task_name: "Vận chuyển trucking từ cảng về kho KBI", task_template_id: "tt_016", department: "FDS_OPS", assignee_code: "O01", assignee: { user_id: "u_ops_03", name: "Minh Đức", department: "FDS_OPS" }, progress: 10, created_at: "2026-06-07T02:00:00.000Z", assigned_at: "2026-06-07T03:00:00.000Z", completed_at: null, status: "TODO", priority: "URGENT", due_date: "2026-06-10", notes: "Giao hàng trễ do xe chưa được điều phối.", blocked_reason: null, blocked_by_party: null }),
        base({ task_id: "task_006", id: "task_006", do_number: "DO-KBI-2026-010", hbl_number: "HBL-KBI-010", request_code: "DO-KBI-2026-010", po_number: "PO-KBI-2026-010", production_contract_number: "KBI-CN-2026-010", task_name: "Phát hành Debit Note / Hóa đơn dịch vụ", task_template_id: "tt_019", department: "FDS_ACCOUNTING", assignee_code: "A01", assignee: { user_id: "u_acc_01", name: "Lan Phương", department: "FDS_ACCOUNTING" }, progress: 100, created_at: "2026-06-05T02:00:00.000Z", assigned_at: "2026-06-05T03:00:00.000Z", completed_at: "2026-06-12T08:00:00.000Z", status: "COMPLETED", priority: "MEDIUM", due_date: "2026-06-12", notes: "Đã tổng hợp phí local và phát hành Debit Note.", blocked_reason: null, blocked_by_party: null }),
        base({ task_id: "task_007", id: "task_007", do_number: "DO-KBI-2026-011", hbl_number: null, request_code: "DO-KBI-2026-011", po_number: "PO-KBI-2026-011", production_contract_number: "KBI-CN-2026-011", task_name: "Chuẩn bị & gửi báo giá (air freight khẩn)", task_template_id: "tt_002", department: "FDS_SALES", assignee_code: "S01", assignee: { user_id: "u_sale_01", name: "Thanh Tùng", department: "FDS_SALES" }, progress: 15, created_at: "2026-06-12T02:00:00.000Z", assigned_at: "2026-06-12T03:00:00.000Z", completed_at: null, status: "TODO", priority: "URGENT", due_date: "2026-06-13", notes: "Báo giá cần chốt trong ngày để giữ slot bay.", blocked_reason: null, blocked_by_party: null }),
        base({ task_id: "task_008", id: "task_008", do_number: "DO-KBI-2026-012", hbl_number: null, request_code: "DO-KBI-2026-012", po_number: "PO-KBI-2026-012", production_contract_number: "KBI-CN-2026-012", task_name: "Booking breakbulk với Carrier", task_template_id: "tt_007", department: "FDS_OPS", assignee_code: "O01", assignee: { user_id: "u_ops_04", name: "Gia Huy", department: "FDS_OPS" }, progress: 75, created_at: "2026-06-10T02:00:00.000Z", assigned_at: "2026-06-10T03:00:00.000Z", completed_at: null, status: "IN_PROGRESS", priority: "MEDIUM", due_date: "2026-06-18", notes: "Đang chờ hãng tàu xác nhận lịch breakbulk.", blocked_reason: null, blocked_by_party: null }),
        base({ task_id: "task_009", id: "task_009", do_number: "DO-KBI-2026-013", hbl_number: "HBL-KBI-013", request_code: "DO-KBI-2026-013", po_number: "PO-KBI-2026-013", production_contract_number: "KBI-CN-2026-013", task_name: "Thu thập & gửi bộ chứng từ gốc cho KBI", task_template_id: "tt_018", department: "FDS_OPS", assignee_code: "O02", assignee: { user_id: "u_ops_05", name: "Bảo Ngọc", department: "FDS_OPS" }, progress: 100, created_at: "2026-06-06T02:00:00.000Z", assigned_at: "2026-06-06T03:00:00.000Z", completed_at: "2026-06-09T08:00:00.000Z", status: "COMPLETED", priority: "LOW", due_date: "2026-06-09", notes: "Đã gửi bộ chứng từ gốc (B/L, Invoice, C/O) cho KBI.", blocked_reason: null, blocked_by_party: null }),
        base({ task_id: "task_010", id: "task_010", do_number: "DO-KBI-2026-014", hbl_number: "HBL-KBI-014", request_code: "DO-KBI-2026-014", po_number: "PO-KBI-2026-014", production_contract_number: "KBI-CN-2026-014", task_name: "Giao hàng ECU tại cổng kho KBI (Gate-in)", task_template_id: "tt_017", department: "FDS_OPS", assignee_code: "O01", assignee: { user_id: "u_ops_06", name: "Nguyễn Khoa", department: "FDS_OPS" }, progress: 35, created_at: "2026-06-12T02:00:00.000Z", assigned_at: "2026-06-12T03:00:00.000Z", completed_at: null, status: "IN_PROGRESS", priority: "HIGH", due_date: "2026-06-16", notes: "Đang chờ lịch xe nội địa để giao ECU về kho.", blocked_reason: null, blocked_by_party: null })
    ],
    "delivery-order-lots": [
        ...
        base({ id: "do_lot_015", delivery_order_id: "do_015", po_lot_id: "lot_016", sort_order: 1 }),
        base({ id: "do_lot_016", delivery_order_id: "do_016", po_lot_id: "lot_017", sort_order: 1 }),
        base({ id: "do_lot_017", delivery_order_id: "do_017", po_lot_id: "lot_018", sort_order: 1 }),
        base({ id: "do_lot_018", delivery_order_id: "do_018", po_lot_id: "lot_019", sort_order: 1 }),
        base({ id: "do_lot_019", delivery_order_id: "do_019", po_lot_id: "lot_020", sort_order: 1 }),
        base({ id: "do_lot_020", delivery_order_id: "do_020", po_lot_id: "lot_021", sort_order: 1 }),
        base({ id: "do_lot_021", delivery_order_id: "do_021", po_lot_id: "lot_022", sort_order: 1 }),
        base({ id: "do_lot_022", delivery_order_id: "do_022", po_lot_id: "lot_023", sort_order: 1 })
    ],
    "delivery-order-lines": [
        ...
        base({ id: "do_line_015", delivery_order_id: "do_015", po_lot_id: "lot_016", purchase_order_line_id: "po_line_018", item_id: "item_001", qty: 20, unit: "PCS", sort_order: 1 }),
        base({ id: "do_line_016", delivery_order_id: "do_016", po_lot_id: "lot_017", purchase_order_line_id: "po_line_019", item_id: "item_003", qty: 25, unit: "SET", sort_order: 1 }),
        base({ id: "do_line_017", delivery_order_id: "do_017", po_lot_id: "lot_018", purchase_order_line_id: "po_line_020", item_id: "item_006", qty: 30, unit: "PCS", sort_order: 1 }),
        base({ id: "do_line_018", delivery_order_id: "do_018", po_lot_id: "lot_019", purchase_order_line_id: "po_line_021", item_id: "item_007", qty: 240, unit: "SET", sort_order: 1 }),
        base({ id: "do_line_019", delivery_order_id: "do_019", po_lot_id: "lot_020", purchase_order_line_id: "po_line_022", item_id: "item_010", qty: 120, unit: "KIT", sort_order: 1 }),
        base({ id: "do_line_020", delivery_order_id: "do_020", po_lot_id: "lot_021", purchase_order_line_id: "po_line_023", item_id: "item_004", qty: 10, unit: "PCS", sort_order: 1 }),
        base({ id: "do_line_021", delivery_order_id: "do_021", po_lot_id: "lot_022", purchase_order_line_id: "po_line_024", item_id: "item_013", qty: 600, unit: "PCS", sort_order: 1 }),
        base({ id: "do_line_022", delivery_order_id: "do_022", po_lot_id: "lot_023", purchase_order_line_id: "po_line_025", item_id: "item_008", qty: 800, unit: "KIT", sort_order: 1 })
    ],
    "quotation-requests": [
        base({
            id: "qr-0001",
        ...
        base({ id: "qr-0004", rfq_no: "RFQ-2026-0004", status: "CONFIRMED", customer_ref: "KBI", customer_po_ref: "KBI-SAP-PO-4500012450", supplier_id: "sup_001", incoterm_code: "FOB", mode: "SEA_FCL", currency_code: "USD", origin_port: "Shanghai (CNSHA)", destination_port: "Cat Lai (VNCLI)", desired_cargo_ready_date: "2026-07-28", gross_weight_kg: 7300, volume_cbm: 62, container_type: "1x40HC", note: "Confirmed by KBI — proceed to PO.", create_at: "2026-07-06T09:20:00+07:00", update_at: "2026-07-06T10:00:00+07:00" }),
        base({ id: "qr-0005", rfq_no: "RFQ-2026-0005", status: "CANCELLED", customer_ref: "KBI", customer_po_ref: "KBI-SAP-PO-4500012477", supplier_id: "sup_002", incoterm_code: "FOB", mode: "SEA_LCL", currency_code: "USD", origin_port: "Shanghai (CNSHA)", destination_port: "Cat Lai (VNCLI)", desired_cargo_ready_date: "2026-08-05", gross_weight_kg: 480, volume_cbm: 4.5, container_type: "LCL", note: "Cancelled by KBI — sourced elsewhere.", create_at: "2026-07-06T09:40:00+07:00", update_at: "2026-07-06T10:10:00+07:00" })
    ],
    "quotation-request-lines": [
        base({ id: "qrl-0001", quotation_request_id: "qr-0001", line_no: 1, item_id: "item_004", item_description: "Bộ điều khiển KBI7921C-CAN", qty: 500, unit: "PCS", unit_price: 82.5, gross_weight_kg: 3600, note: null, create_at: "2026-07-06T08:00:00+07:00", update_at: "2026-07-06T08:00:00+07:00" }),
        base({ id: "qrl-0002", quotation_request_id: "qr-0001", line_no: 2, item_id: "item_005", item_description: "Bộ sạc LBC1206B", qty: 300, unit: "PCS", unit_price: 20.4, gross_weight_kg: 1800, note: null, create_at: "2026-07-06T08:00:00+07:00", update_at: "2026-07-06T08:00:00+07:00" }),
        base({ id: "qrl-0003", quotation_request_id: "qr-0002", line_no: 1, item_id: "item_029", item_description: "Cảm biến nhiên liệu KUS MGS-E870", qty: 240, unit: "PCS", unit_price: 12.5, gross_weight_kg: 420, note: null, create_at: "2026-07-06T08:20:00+07:00", update_at: "2026-07-06T08:20:00+07:00" }),
        base({ id: "qrl-0004", quotation_request_id: "qr-0002", line_no: 2, item_id: "item_030", item_description: "Cảm biến nhiên liệu KUS CLS2-E790 (240-33ohm)", qty: 180, unit: "PCS", unit_price: 32.06, gross_weight_kg: 560, note: null, create_at: "2026-07-06T08:20:00+07:00", update_at: "2026-07-06T08:20:00+07:00" }),
        base({ id: "qrl-0005", quotation_request_id: "qr-0003", line_no: 1, item_id: "item_024", item_description: "Ổ cắm Kripal 63A - 230Vac - 2P+E - 6H - IP44 (UKS-B3341-6)", qty: 120, unit: "PCS", unit_price: 6.63, gross_weight_kg: 640, note: null, create_at: "2026-07-06T08:45:00+07:00", update_at: "2026-07-06T08:45:00+07:00" }),
        base({ id: "qrl-0006", quotation_request_id: "qr-0003", line_no: 2, item_id: "item_025", item_description: "Phích cắm Kripal 63A - 230Vac - 2P+E - 6H - IP44 (UKS-A334-6)", qty: 150, unit: "PCS", unit_price: 5.31, gross_weight_kg: 800, note: null, create_at: "2026-07-06T08:45:00+07:00", update_at: "2026-07-06T08:45:00+07:00" }),
        base({ id: "qrl-0007", quotation_request_id: "qr-0004", line_no: 1, item_id: "item_003", item_description: "Áo sơ mi nam dài tay size M", qty: 2000, unit: "PCS", unit_price: 8.5, gross_weight_kg: 4200, note: null, create_at: "2026-07-06T09:20:00+07:00", update_at: "2026-07-06T09:20:00+07:00" }),
        base({ id: "qrl-0008", quotation_request_id: "qr-0004", line_no: 2, item_id: "item_006", item_description: "Mút RF01 PU 1600 x 1000 x 30mm 25D", qty: 500, unit: "PCS", unit_price: 7.2, gross_weight_kg: 900, note: null, create_at: "2026-07-06T09:20:00+07:00", update_at: "2026-07-06T09:20:00+07:00" }),
        base({ id: "qrl-0009", quotation_request_id: "qr-0005", line_no: 1, item_id: "item_002", item_description: "Chỉ may polyester trắng số 40", qty: 800, unit: "CUON", unit_price: 0.5, gross_weight_kg: 480, note: null, create_at: "2026-07-06T09:40:00+07:00", update_at: "2026-07-06T09:40:00+07:00" })
    ],
    "quotations": [
        ...
        base({ id: "qt_025", quotation_group_id: "qg_qt_025", quotation_no: "QT-KBI-2026-025", version: 1, ref_type: null, ref_id: null, rfq_id: "qr-0004", customer_ref: "KBI", supplier_id: "sup_fds_forwarder", quotation_type: "FREIGHT", incoterm_code: "FOB", mode: "SEA_FCL", origin_port: "Shanghai (CNSHA)", destination_port: "Cat Lai (VNCLI)", selected_option_id: "qo-0003", currency_code: "USD", exchange_rate: 25000, status: "CONFIRMED", is_final: true, confirmed_at: "2026-06-30T02:00:00.000Z", quoted_at: "2026-06-29T02:00:00.000Z", valid_until: dayFromToday(30), note: "Confirmed from RFQ RFQ-2026-0004 — ready to create PO." }),
        base({ id: "qt_026", quotation_group_id: "qg_qt_026", quotation_no: "QT-KBI-2026-026", version: 1, ref_type: null, ref_id: null, customer_ref: "KBI", supplier_id: "sup_fds_forwarder", quotation_type: "FREIGHT", incoterm_code: "FOB", mode: "SEA_LCL", origin_port: "Ningbo (CNNGB)", destination_port: "Cat Lai (VNCLI)", selected_option_id: "qo-0004", currency_code: "USD", exchange_rate: 25000, status: "PENDING_APPROVAL", is_final: false, quoted_at: "2026-06-30T02:00:00.000Z", valid_until: dayFromToday(20), note: "Sent to KBI with an option selected — ready to confirm." })
    ],
    "quotation-options": [
        base({
            id: "qo-0001",
        ...
        base({ id: "qo-0003", quotation_id: "qt_025", option_no: 1, carrier_code: "COSCO", carrier_name: "COSCO Shipping Lines", vessel_or_flight: "COSCO STAR", voyage_flight_no: "CS128E", etd: "2026-07-30", eta: "2026-08-07", transit_time_days: 8, risk_warning: null, headline_amount: 44500000, is_recommended: true, is_selected: true, create_at: "2026-07-06T09:20:00+07:00", update_at: "2026-07-06T09:20:00+07:00" }),
        base({ id: "qo-0004", quotation_id: "qt_026", option_no: 1, carrier_code: "WANHAI", carrier_name: "Wan Hai Lines", vessel_or_flight: "WAN HAI 288", voyage_flight_no: "WH288S", etd: "2026-07-12", eta: "2026-07-20", transit_time_days: 8, risk_warning: null, headline_amount: 12500000, is_recommended: true, is_selected: true, create_at: "2026-07-06T09:30:00+07:00", update_at: "2026-07-06T09:30:00+07:00" }),
        base({ id: "qo-0005", quotation_id: "qt_026", option_no: 2, carrier_code: "SITC", carrier_name: "SITC Container Lines", vessel_or_flight: "SITC HAIPHONG", voyage_flight_no: "ST090S", etd: "2026-07-15", eta: "2026-07-22", transit_time_days: 7, risk_warning: "Limited free time at destination", headline_amount: 13100000, is_recommended: false, is_selected: false, create_at: "2026-07-06T09:30:00+07:00", update_at: "2026-07-06T09:30:00+07:00" })
    ],
    "quotation-charge-lines": [
        ...
        base({ id: "qt_line_040", quotation_id: "qt_025", charge_type: "OCEAN_FREIGHT", description: "Shanghai to Cat Lai 40HC", quantity: 1, unit: "CONT", unit_price: 1650, amount: 1650, currency_code: "USD", tax_rate: 0, note: null }),
        base({ id: "qt_line_041", quotation_id: "qt_025", charge_type: "THC", description: "Terminal handling charge", quantity: 1, unit: "CONT", unit_price: 130, amount: 130, currency_code: "USD", tax_rate: 0, note: null }),
        base({ id: "qt_line_042", quotation_id: "qt_026", charge_type: "OCEAN_FREIGHT", description: "Ningbo to Cat Lai LCL", quantity: 5, unit: "RT", unit_price: 90, amount: 450, currency_code: "USD", tax_rate: 0, note: "CBM basis." })
    ],
    "quotation-events": [
    ...
    "shipments": [
        ...
        // po_003 (KOWEI) left the factory 5 days late, so this lô sailed and landed 5 days late.
        base({ id: "shp_002", shipment_no: "SHP-KBI-2026-002", delivery_order_id: "do_002", mode: "SEA", load_type: "LCL", forwarder_id: "fwd_001", carrier_id: "carr_001", carrier: "Mediterranean Shipping Company", vessel_flight: "OOCL ASIA 021S", bl_awb_no: "BL-SHA-002", container_no: "LCL-SHA-002", pol: "CNSHA", pod: "VNHPH", etd: "2026-06-24", eta: "2026-07-02", atd: "2026-06-29", ata: "2026-07-07", status: "CUSTOMS_CLEARED" }),
        base({ id: "shp_003", shipment_no: "SHP-KBI-2026-003", delivery_order_id: "do_002", mode: "AIR", load_type: null, forwarder_id: "fwd_001", carrier_id: "carr_010", carrier: "Vietnam Airlines Cargo", vessel_flight: "VN996", bl_awb_no: "AWB-003", container_no: null, pol: "PVG", pod: "HAN", etd: "2026-06-26", eta: "2026-06-27", atd: "2026-06-26", ata: "2026-06-27", status: "DELIVERED" }),
        base({ id: "shp_004", shipment_no: "SHP-KBI-2026-004", delivery_order_id: "do_004", mode: "TRUCKING", load_type: "FTL", forwarder_id: "fwd_001", carrier_id: null, carrier: null, vessel_flight: null, bl_awb_no: null, container_no: "TRUCK-004", pol: "Hai Phong", pod: "Kim Binh", etd: "2026-07-20", eta: "2026-07-21", atd: null, ata: null, status: "BOOKING_CONFIRMED" }),
        base({ id: "shp_005", shipment_no: "SHP-KBI-2026-005", delivery_order_id: "do_005", mode: "SEA", load_type: "FCL", forwarder_id: "fwd_001", carrier_id: "carr_006", carrier: "Maersk Line", vessel_flight: "MAERSK NANSHA 241S", bl_awb_no: "BL-SHA-005", container_no: "MSKU7654321", pol: "CNSHA", pod: "VNHPH", etd: "2026-07-22", eta: "2026-07-30", atd: null, ata: null, status: "CUSTOMS_CLEARED" }),
        // po_006 (NAIBO) released 3 days late; still airborne, no ATA yet.
        base({ id: "shp_006", shipment_no: "SHP-KBI-2026-006", delivery_order_id: "do_006", mode: "AIR", load_type: null, forwarder_id: "fwd_001", carrier_id: "carr_009", carrier: "Turkish Airlines", vessel_flight: "CX052", bl_awb_no: "AWB-006", container_no: null, pol: "PVG", pod: "HAN", etd: "2026-08-04", eta: "2026-08-05", atd: "2026-08-07", ata: null, status: "ATD" }),
        // po_007 (KOWEI) left 6 days late, so the lô landed 6 days after ETA.
        base({ id: "shp_007", shipment_no: "SHP-KBI-2026-007", delivery_order_id: "do_007", mode: "SEA", load_type: "LCL", forwarder_id: "fwd_001", carrier_id: "carr_005", carrier: "WAN HAI Lines Ltd.", vessel_flight: "SITC HAIPHONG 088S", bl_awb_no: "BL-NGB-007", container_no: "LCL-NGB-007", pol: "CNNGB", pod: "VNHPH", etd: "2026-06-30", eta: "2026-07-08", atd: "2026-07-06", ata: "2026-07-14", status: "CUSTOMS_CLEARED" }),
        // po_008 (Yongji) slipped 2 days at origin; en route, no ATA yet.
        base({ id: "shp_008", shipment_no: "SHP-KBI-2026-008", delivery_order_id: "do_008", mode: "SEA", load_type: "FCL", forwarder_id: "fwd_001", carrier_id: "carr_007", carrier: "Evergreen Marine Corporation (EMC)", vessel_flight: "ONE ORPHEUS 077S", bl_awb_no: "BL-SHA-008", container_no: "TGBU9876543", pol: "CNSHA", pod: "VNHPH", etd: "2026-07-14", eta: "2026-07-22", atd: "2026-07-16", ata: null, status: "ARRIVAL_NOTICE" }),
        base({ id: "shp_009", shipment_no: "SHP-KBI-2026-009", delivery_order_id: "do_009", mode: "TRUCKING", load_type: "FTL", forwarder_id: "fwd_001", carrier_id: null, carrier: null, vessel_flight: null, bl_awb_no: "CMR-CB-009", container_no: "TRUCK-CB-009", pol: "Pingxiang Border", pod: "Kim Binh", etd: "2026-08-12", eta: "2026-08-14", atd: "2026-08-12", ata: "2026-08-14", status: "DELIVERED" }),
        // po_010 (PAIRGEARS) shipped 7 days late, so the lô landed 7 days after ETA.
        base({ id: "shp_010", shipment_no: "SHP-KBI-2026-010", delivery_order_id: "do_010", mode: "SEA", load_type: "LCL", forwarder_id: "fwd_001", carrier_id: "carr_002", carrier: "Cheng Lie Navigation Company (CNC)", vessel_flight: "SITC SHANGHAI 116S", bl_awb_no: "BL-SHA-010", container_no: "LCL-SHA-010", pol: "CNSHA", pod: "VNHPH", etd: "2026-08-18", eta: "2026-08-26", atd: "2026-08-25", ata: "2026-09-02", status: "CUSTOMS_CLEARED" }),
        base({ id: "shp_011", shipment_no: "SHP-KBI-2026-011", delivery_order_id: "do_011", mode: "AIR", load_type: null, forwarder_id: "fwd_001", carrier_id: "carr_010", carrier: "Vietnam Airlines Cargo", vessel_flight: "MU7711", bl_awb_no: "AWB-011", container_no: null, pol: "PVG", pod: "HAN", etd: "2026-09-03", eta: "2026-09-04", atd: "2026-09-03", ata: null, status: "ATD" }),
        base({ id: "shp_012", shipment_no: "SHP-KBI-2026-012", delivery_order_id: "do_012", mode: "SEA", load_type: null, forwarder_id: "fwd_001", carrier_id: "carr_003", carrier: "COSCO Shipping Lines", vessel_flight: "COSCO HEAVY 031S", bl_awb_no: "BBL-SHA-012", container_no: null, pol: "CNSHA", pod: "VNHPH", etd: "2026-09-08", eta: "2026-09-18", atd: null, ata: null, status: "BOOKING_CONFIRMED" }),
        base({ id: "shp_013", shipment_no: "SHP-KBI-2026-013", delivery_order_id: "do_013", mode: "SEA", load_type: "FCL", forwarder_id: "fwd_001", carrier_id: "carr_006", carrier: "Maersk Line", vessel_flight: "MAERSK SHANGHAI 193S", bl_awb_no: "BL-SHA-013", container_no: "MRKU2468135", pol: "CNSHA", pod: "VNHPH", etd: "2026-08-05", eta: "2026-08-13", atd: "2026-08-05", ata: "2026-08-13", status: "DELIVERED" }),
        // po_014 (KOWEI) held 4 extra days for QC, so the lô landed 4 days after ETA.
        base({ id: "shp_014", shipment_no: "SHP-KBI-2026-014", delivery_order_id: "do_014", mode: "AIR", load_type: null, forwarder_id: "fwd_001", carrier_id: "carr_008", carrier: "ShunFeng Airlines", vessel_flight: "O36918", bl_awb_no: "AWB-014", container_no: null, pol: "PVG", pod: "HAN", etd: "2026-08-28", eta: "2026-08-29", atd: "2026-09-01", ata: "2026-09-02", status: "DELIVERED" }),
        base({ id: "shp_015", shipment_no: "SHP-KBI-2026-015", delivery_order_id: "do_015", mode: "SEA", load_type: "FCL", forwarder_id: "fwd_001", carrier_id: "carr_001", carrier: "COSCO Shipping Lines", vessel_flight: "COSCO STAR 128E", bl_awb_no: "BL-SHA-015", container_no: "CBHU2233445", pol: "CNSHA", pod: "VNSGN", etd: "2026-07-30", eta: "2026-08-07", atd: "2026-07-30", ata: null, status: "IN_TRANSIT" }),
        base({ id: "shp_016", shipment_no: "SHP-KBI-2026-016", delivery_order_id: "do_022", mode: "SEA", load_type: "FCL", forwarder_id: "fwd_001", carrier_id: "carr_002", carrier: "Evergreen Marine Corp", vessel_flight: "EVER GIVEN 015S", bl_awb_no: "BL-SHA-016", container_no: "EGHU5566778", pol: "CNSHA", pod: "VNHPH", etd: "2026-07-16", eta: "2026-07-22", atd: "2026-07-16", ata: "2026-07-22", status: "CUSTOMS_DRAFT" })
    ],
    "shipment-lines": [
        ...
        base({ id: "shp_line_015", shipment_id: "shp_015", delivery_order_line_id: "do_line_015", purchase_order_line_id: "po_line_018", po_lot_id: "lot_016", item_id: "item_001", qty_shipped: 20, unit: "PCS", sort_order: 1 }),
        base({ id: "shp_line_016", shipment_id: "shp_016", delivery_order_line_id: "do_line_022", purchase_order_line_id: "po_line_025", po_lot_id: "lot_023", item_id: "item_008", qty_shipped: 800, unit: "KIT", sort_order: 1 })
    ],
    ...
    // DO customs documents. Curated so the "documents complete" gate demoes every state
    // (see docs/BE_rule.md). Close button appears only at derived ASSIGNED_TO_SHIPMENT:
    //   do_001 = RED (missing CO -> close blocked)
    //   do_004 = AMBER (all uploaded, some not VERIFIED -> close needs acknowledgement)
    //   do_012 = GREEN (all VERIFIED -> clean close)
    // Terminal/advanced DOs (CUSTOMS_CLEARED / DELIVERED / CLOSED) carry a complete,
    // VERIFIED set; mid-transit DOs are partial; early DOs (DRAFT..QUOTATION) have none.
    "delivery-order-documents": [
        // do_001 - ASSIGNED_TO_SHIPMENT - RED: required CO still missing (close blocked)
        ...
        // do_002 - CUSTOMS_CLEARED - complete, all VERIFIED
        ...
        base({ id: "do_doc_006", delivery_order_id: "do_002", document_type: "Packing List", document_no: "PL-DO-002", file_url: "/mock/files/pl-do-002.pdf", file_name: "pl-do-002.pdf", mime_type: "application/pdf", received_at: "2026-06-24T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_007", delivery_order_id: "do_002", document_type: "B/L", document_no: "BL-SHA-002", file_url: "/mock/files/bl-sha-002.pdf", file_name: "bl-sha-002.pdf", mime_type: "application/pdf", received_at: "2026-06-25T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_008", delivery_order_id: "do_002", document_type: "CO", document_no: "CO-FORM-E-002", file_url: "/mock/files/co-002.pdf", file_name: "co-002.pdf", mime_type: "application/pdf", received_at: "2026-06-25T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: "Form E for preferential duty." }),
        // do_004 - ASSIGNED_TO_SHIPMENT - AMBER: all required uploaded, PL/B/L/CO not yet VERIFIED
        base({ id: "do_doc_009", delivery_order_id: "do_004", document_type: "Invoice", document_no: "CI-DO-004", file_url: "/mock/files/ci-do-004.pdf", file_name: "ci-do-004.pdf", mime_type: "application/pdf", received_at: "2026-07-22T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_010", delivery_order_id: "do_004", document_type: "Packing List", document_no: "PL-DO-004", file_url: "/mock/files/pl-do-004.pdf", file_name: "pl-do-004.pdf", mime_type: "application/pdf", received_at: "2026-07-22T00:00:00.000Z", status: "RECEIVED", is_required: true, notes: null }),
        base({ id: "do_doc_011", delivery_order_id: "do_004", document_type: "B/L", document_no: "BL-DO-004", file_url: "/mock/files/bl-do-004.pdf", file_name: "bl-do-004.pdf", mime_type: "application/pdf", received_at: "2026-07-23T00:00:00.000Z", status: "RECEIVED", is_required: true, notes: null }),
        base({ id: "do_doc_012", delivery_order_id: "do_004", document_type: "CO", document_no: "CO-FORM-E-004", file_url: "/mock/files/co-004.pdf", file_name: "co-004.pdf", mime_type: "application/pdf", received_at: "2026-07-23T00:00:00.000Z", status: "RECEIVED", is_required: true, notes: "Awaiting accounting verification." }),
        // do_005 - CUSTOMS_CLEARED - GREEN: complete, all VERIFIED (+ optional debit note)
        base({ id: "do_doc_013", delivery_order_id: "do_005", document_type: "Invoice", document_no: "CI-DO-005", file_url: "/mock/files/ci-do-005.pdf", file_name: "ci-do-005.pdf", mime_type: "application/pdf", received_at: "2026-07-18T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_014", delivery_order_id: "do_005", document_type: "Packing List", document_no: "PL-DO-005", file_url: "/mock/files/pl-do-005.pdf", file_name: "pl-do-005.pdf", mime_type: "application/pdf", received_at: "2026-07-18T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_015", delivery_order_id: "do_005", document_type: "B/L", document_no: "BL-SHA-005", file_url: "/mock/files/bl-sha-005.pdf", file_name: "bl-sha-005.pdf", mime_type: "application/pdf", received_at: "2026-07-19T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_016", delivery_order_id: "do_005", document_type: "CO", document_no: "CO-FORM-E-005", file_url: "/mock/files/co-005.pdf", file_name: "co-005.pdf", mime_type: "application/pdf", received_at: "2026-07-19T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_017", delivery_order_id: "do_005", document_type: "Debit Note", document_no: "DN-005", file_url: "/mock/files/dn-005.pdf", file_name: "dn-005.pdf", mime_type: "application/pdf", received_at: "2026-07-31T00:00:00.000Z", status: "RECEIVED", is_required: false, notes: "Arising freight surcharge debit note." }),
        // do_006 - IN_TRANSIT - partial (Invoice + Packing List only)
        base({ id: "do_doc_018", delivery_order_id: "do_006", document_type: "Invoice", document_no: "CI-DO-006", file_url: "/mock/files/ci-do-006.pdf", file_name: "ci-do-006.pdf", mime_type: "application/pdf", received_at: "2026-08-02T00:00:00.000Z", status: "RECEIVED", is_required: true, notes: null }),
        base({ id: "do_doc_019", delivery_order_id: "do_006", document_type: "Packing List", document_no: "PL-DO-006", file_url: "/mock/files/pl-do-006.pdf", file_name: "pl-do-006.pdf", mime_type: "application/pdf", received_at: "2026-08-02T00:00:00.000Z", status: "RECEIVED", is_required: true, notes: null }),
        // do_007 - CUSTOMS_CLEARED - complete, all VERIFIED
        base({ id: "do_doc_020", delivery_order_id: "do_007", document_type: "Invoice", document_no: "CI-DO-007", file_url: "/mock/files/ci-do-007.pdf", file_name: "ci-do-007.pdf", mime_type: "application/pdf", received_at: "2026-06-30T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_021", delivery_order_id: "do_007", document_type: "Packing List", document_no: "PL-DO-007", file_url: "/mock/files/pl-do-007.pdf", file_name: "pl-do-007.pdf", mime_type: "application/pdf", received_at: "2026-06-30T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_022", delivery_order_id: "do_007", document_type: "B/L", document_no: "BL-NGB-007", file_url: "/mock/files/bl-ngb-007.pdf", file_name: "bl-ngb-007.pdf", mime_type: "application/pdf", received_at: "2026-07-01T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_023", delivery_order_id: "do_007", document_type: "CO", document_no: "CO-FORM-E-007", file_url: "/mock/files/co-007.pdf", file_name: "co-007.pdf", mime_type: "application/pdf", received_at: "2026-07-01T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        // do_008 - ARRIVED_PORT - near complete, CO still outstanding
        base({ id: "do_doc_024", delivery_order_id: "do_008", document_type: "Invoice", document_no: "CI-DO-008", file_url: "/mock/files/ci-do-008.pdf", file_name: "ci-do-008.pdf", mime_type: "application/pdf", received_at: "2026-07-16T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_025", delivery_order_id: "do_008", document_type: "Packing List", document_no: "PL-DO-008", file_url: "/mock/files/pl-do-008.pdf", file_name: "pl-do-008.pdf", mime_type: "application/pdf", received_at: "2026-07-16T00:00:00.000Z", status: "RECEIVED", is_required: true, notes: null }),
        base({ id: "do_doc_026", delivery_order_id: "do_008", document_type: "B/L", document_no: "BL-DO-008", file_url: "/mock/files/bl-do-008.pdf", file_name: "bl-do-008.pdf", mime_type: "application/pdf", received_at: "2026-07-17T00:00:00.000Z", status: "RECEIVED", is_required: true, notes: "CO Form E pending hard copy." }),
        // do_009 - DELIVERED - complete, all VERIFIED
        base({ id: "do_doc_027", delivery_order_id: "do_009", document_type: "Invoice", document_no: "CI-DO-009", file_url: "/mock/files/ci-do-009.pdf", file_name: "ci-do-009.pdf", mime_type: "application/pdf", received_at: "2026-08-10T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_028", delivery_order_id: "do_009", document_type: "Packing List", document_no: "PL-DO-009", file_url: "/mock/files/pl-do-009.pdf", file_name: "pl-do-009.pdf", mime_type: "application/pdf", received_at: "2026-08-10T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_029", delivery_order_id: "do_009", document_type: "B/L", document_no: "BL-DO-009", file_url: "/mock/files/bl-do-009.pdf", file_name: "bl-do-009.pdf", mime_type: "application/pdf", received_at: "2026-08-11T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_030", delivery_order_id: "do_009", document_type: "CO", document_no: "CO-FORM-E-009", file_url: "/mock/files/co-009.pdf", file_name: "co-009.pdf", mime_type: "application/pdf", received_at: "2026-08-11T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        // do_010 - CUSTOMS_CLEARED - complete, all VERIFIED
        base({ id: "do_doc_031", delivery_order_id: "do_010", document_type: "Invoice", document_no: "CI-DO-010", file_url: "/mock/files/ci-do-010.pdf", file_name: "ci-do-010.pdf", mime_type: "application/pdf", received_at: "2026-08-20T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_032", delivery_order_id: "do_010", document_type: "Packing List", document_no: "PL-DO-010", file_url: "/mock/files/pl-do-010.pdf", file_name: "pl-do-010.pdf", mime_type: "application/pdf", received_at: "2026-08-20T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_033", delivery_order_id: "do_010", document_type: "B/L", document_no: "BL-SHA-010", file_url: "/mock/files/bl-sha-010.pdf", file_name: "bl-sha-010.pdf", mime_type: "application/pdf", received_at: "2026-08-20T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_034", delivery_order_id: "do_010", document_type: "CO", document_no: "CO-FORM-E-010", file_url: "/mock/files/co-010.pdf", file_name: "co-010.pdf", mime_type: "application/pdf", received_at: "2026-08-21T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        // do_011 - IN_TRANSIT - partial (Invoice + B/L)
        base({ id: "do_doc_035", delivery_order_id: "do_011", document_type: "Invoice", document_no: "CI-DO-011", file_url: "/mock/files/ci-do-011.pdf", file_name: "ci-do-011.pdf", mime_type: "application/pdf", received_at: "2026-08-28T00:00:00.000Z", status: "RECEIVED", is_required: true, notes: null }),
        base({ id: "do_doc_036", delivery_order_id: "do_011", document_type: "B/L", document_no: "BL-DO-011", file_url: "/mock/files/bl-do-011.pdf", file_name: "bl-do-011.pdf", mime_type: "application/pdf", received_at: "2026-08-29T00:00:00.000Z", status: "RECEIVED", is_required: true, notes: null }),
        // do_012 - ASSIGNED_TO_SHIPMENT - GREEN: complete, all VERIFIED (clean close demo)
        base({ id: "do_doc_037", delivery_order_id: "do_012", document_type: "Invoice", document_no: "CI-DO-012", file_url: "/mock/files/ci-do-012.pdf", file_name: "ci-do-012.pdf", mime_type: "application/pdf", received_at: "2026-09-08T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_038", delivery_order_id: "do_012", document_type: "Packing List", document_no: "PL-DO-012", file_url: "/mock/files/pl-do-012.pdf", file_name: "pl-do-012.pdf", mime_type: "application/pdf", received_at: "2026-09-08T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_039", delivery_order_id: "do_012", document_type: "B/L", document_no: "BL-DO-012", file_url: "/mock/files/bl-do-012.pdf", file_name: "bl-do-012.pdf", mime_type: "application/pdf", received_at: "2026-09-09T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_040", delivery_order_id: "do_012", document_type: "CO", document_no: "CO-FORM-E-012", file_url: "/mock/files/co-012.pdf", file_name: "co-012.pdf", mime_type: "application/pdf", received_at: "2026-09-09T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        // do_013 - DELIVERED - complete, all VERIFIED
        base({ id: "do_doc_041", delivery_order_id: "do_013", document_type: "Invoice", document_no: "CI-DO-013", file_url: "/mock/files/ci-do-013.pdf", file_name: "ci-do-013.pdf", mime_type: "application/pdf", received_at: "2026-08-06T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_042", delivery_order_id: "do_013", document_type: "Packing List", document_no: "PL-DO-013", file_url: "/mock/files/pl-do-013.pdf", file_name: "pl-do-013.pdf", mime_type: "application/pdf", received_at: "2026-08-06T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_043", delivery_order_id: "do_013", document_type: "B/L", document_no: "BL-SHA-013", file_url: "/mock/files/bl-sha-013.pdf", file_name: "bl-sha-013.pdf", mime_type: "application/pdf", received_at: "2026-08-06T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_044", delivery_order_id: "do_013", document_type: "CO", document_no: "CO-FORM-E-013", file_url: "/mock/files/co-013.pdf", file_name: "co-013.pdf", mime_type: "application/pdf", received_at: "2026-08-07T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        // do_014 - CLOSED - complete, all VERIFIED (a closed file must have full paperwork)
        base({ id: "do_doc_045", delivery_order_id: "do_014", document_type: "Invoice", document_no: "CI-DO-014", file_url: "/mock/files/ci-do-014.pdf", file_name: "ci-do-014.pdf", mime_type: "application/pdf", received_at: "2026-08-27T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_046", delivery_order_id: "do_014", document_type: "Packing List", document_no: "PL-DO-014", file_url: "/mock/files/pl-do-014.pdf", file_name: "pl-do-014.pdf", mime_type: "application/pdf", received_at: "2026-08-27T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_047", delivery_order_id: "do_014", document_type: "B/L", document_no: "BL-DO-014", file_url: "/mock/files/bl-do-014.pdf", file_name: "bl-do-014.pdf", mime_type: "application/pdf", received_at: "2026-08-28T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_048", delivery_order_id: "do_014", document_type: "CO", document_no: "CO-FORM-E-014", file_url: "/mock/files/co-014.pdf", file_name: "co-014.pdf", mime_type: "application/pdf", received_at: "2026-08-28T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        // do_015 - IN_TRANSIT - CO uploaded then REJECTED, so still outstanding (rejected != uploaded)
        base({ id: "do_doc_049", delivery_order_id: "do_015", document_type: "Invoice", document_no: "CI-DO-015", file_url: "/mock/files/ci-do-015.pdf", file_name: "ci-do-015.pdf", mime_type: "application/pdf", received_at: "2026-09-02T00:00:00.000Z", status: "RECEIVED", is_required: true, notes: null }),
        base({ id: "do_doc_050", delivery_order_id: "do_015", document_type: "Packing List", document_no: "PL-DO-015", file_url: "/mock/files/pl-do-015.pdf", file_name: "pl-do-015.pdf", mime_type: "application/pdf", received_at: "2026-09-02T00:00:00.000Z", status: "RECEIVED", is_required: true, notes: null }),
        base({ id: "do_doc_051", delivery_order_id: "do_015", document_type: "B/L", document_no: "BL-DO-015", file_url: "/mock/files/bl-do-015.pdf", file_name: "bl-do-015.pdf", mime_type: "application/pdf", received_at: "2026-09-03T00:00:00.000Z", status: "RECEIVED", is_required: true, notes: null }),
        base({ id: "do_doc_052", delivery_order_id: "do_015", document_type: "CO", document_no: "CO-FORM-E-015", file_url: "/mock/files/co-015.pdf", file_name: "co-015.pdf", mime_type: "application/pdf", received_at: "2026-09-03T00:00:00.000Z", status: "REJECTED", is_required: true, notes: "Wrong CO form; awaiting corrected copy from supplier." }),
        // do_021 - WAREHOUSE_PENDING - complete, all VERIFIED (+ optional insurance)
        base({ id: "do_doc_053", delivery_order_id: "do_021", document_type: "Invoice", document_no: "CI-DO-021", file_url: "/mock/files/ci-do-021.pdf", file_name: "ci-do-021.pdf", mime_type: "application/pdf", received_at: "2026-08-15T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_054", delivery_order_id: "do_021", document_type: "Packing List", document_no: "PL-DO-021", file_url: "/mock/files/pl-do-021.pdf", file_name: "pl-do-021.pdf", mime_type: "application/pdf", received_at: "2026-08-15T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_055", delivery_order_id: "do_021", document_type: "B/L", document_no: "BL-DO-021", file_url: "/mock/files/bl-do-021.pdf", file_name: "bl-do-021.pdf", mime_type: "application/pdf", received_at: "2026-08-16T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_056", delivery_order_id: "do_021", document_type: "CO", document_no: "CO-FORM-E-021", file_url: "/mock/files/co-021.pdf", file_name: "co-021.pdf", mime_type: "application/pdf", received_at: "2026-08-16T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_057", delivery_order_id: "do_021", document_type: "Insurance Certificate", document_no: "INS-021", file_url: "/mock/files/ins-021.pdf", file_name: "ins-021.pdf", mime_type: "application/pdf", received_at: "2026-08-17T00:00:00.000Z", status: "RECEIVED", is_required: false, notes: "Cargo insurance certificate." }),
        // do_022 - CUSTOMS_PROCESSING - partial (Invoice + B/L)
        base({ id: "do_doc_058", delivery_order_id: "do_022", document_type: "Invoice", document_no: "CI-DO-022", file_url: "/mock/files/ci-do-022.pdf", file_name: "ci-do-022.pdf", mime_type: "application/pdf", received_at: "2026-09-05T00:00:00.000Z", status: "VERIFIED", is_required: true, notes: null }),
        base({ id: "do_doc_059", delivery_order_id: "do_022", document_type: "B/L", document_no: "BL-DO-022", file_url: "/mock/files/bl-do-022.pdf", file_name: "bl-do-022.pdf", mime_type: "application/pdf", received_at: "2026-09-06T00:00:00.000Z", status: "RECEIVED", is_required: true, notes: null })
    ],
    ...
    "carrier-delivery-orders": [
        base({ id: "cdo_001", shipment_id: "shp_001", carrier_do_no: "CDO-KBI-2026-001", forwarder_id: "fwd_001", issued_date: "2026-07-16", expired_date: "2026-07-23", release_location: "Hai Phong Port", container_no: "CBHU1234567", local_charge_amount: 0, currency_code: "VND", status: "PENDING", note: "Waiting customs clearance." }),
        base({ id: "cdo_002", shipment_id: "shp_002", carrier_do_no: "CDO-KBI-2026-002", forwarder_id: "fwd_001", issued_date: "2026-07-02", expired_date: "2026-07-09", release_location: "Hai Phong Port", container_no: "LCL-SHA-002", local_charge_amount: 3500000, currency_code: "VND", status: "RELEASED", note: null }),
        base({ id: "cdo_003", shipment_id: "shp_003", carrier_do_no: "CDO-KBI-2026-003", forwarder_id: "fwd_001", issued_date: "2026-06-27", expired_date: "2026-07-04", release_location: "Noi Bai Cargo", container_no: null, local_charge_amount: 1200000, currency_code: "VND", status: "RELEASED", note: null }),
        base({ id: "cdo_004", shipment_id: "shp_004", carrier_do_no: "CDO-KBI-2026-004", forwarder_id: "fwd_001", issued_date: "2026-07-21", expired_date: "2026-07-25", release_location: "Hai Phong Port", container_no: "TRUCK-004", local_charge_amount: 0, currency_code: "VND", status: "PENDING", note: null }),
        base({ id: "cdo_005", shipment_id: "shp_005", carrier_do_no: "CDO-KBI-2026-005", forwarder_id: "fwd_001", issued_date: "2026-07-30", expired_date: "2026-08-06", release_location: "Hai Phong Port", container_no: "MSKU7654321", local_charge_amount: 4200000, currency_code: "VND", status: "RELEASED", note: "Released after customs clearance refresh." }),
        base({ id: "cdo_006", shipment_id: "shp_006", carrier_do_no: "CDO-KBI-2026-006", forwarder_id: "fwd_001", issued_date: "2026-08-05", expired_date: "2026-08-08", release_location: "Noi Bai Cargo", container_no: null, local_charge_amount: 1800000, currency_code: "VND", status: "ISSUED", note: "Airport cargo release scheduled after customs." }),
        base({ id: "cdo_007", shipment_id: "shp_007", carrier_do_no: "CDO-KBI-2026-007", forwarder_id: "fwd_001", issued_date: "2026-07-08", expired_date: "2026-07-15", release_location: "Hai Phong CFS", container_no: "LCL-NGB-007", local_charge_amount: 2600000, currency_code: "VND", status: "RELEASED", note: "LCL cargo released from CFS." }),
        base({ id: "cdo_008", shipment_id: "shp_008", carrier_do_no: "CDO-KBI-2026-008", forwarder_id: "fwd_001", issued_date: "2026-07-22", expired_date: "2026-07-29", release_location: "Hai Phong Port", container_no: "TGBU9876543", local_charge_amount: 4800000, currency_code: "VND", status: "PENDING", note: "Arrival notice received." }),
        base({ id: "cdo_009", shipment_id: "shp_009", carrier_do_no: "CDO-KBI-2026-009", forwarder_id: "fwd_001", issued_date: "2026-08-14", expired_date: "2026-08-17", release_location: "Kim Binh Factory", container_no: "TRUCK-CB-009", local_charge_amount: 0, currency_code: "VND", status: "RELEASED", note: "Road shipment delivered directly to factory." }),
        base({ id: "cdo_010", shipment_id: "shp_010", carrier_do_no: "CDO-KBI-2026-010", forwarder_id: "fwd_001", issued_date: "2026-08-26", expired_date: "2026-09-02", release_location: "Hai Phong CFS", container_no: "LCL-SHA-010", local_charge_amount: 2200000, currency_code: "VND", status: "RELEASED", note: "Released after customs clearance." }),
        base({ id: "cdo_011", shipment_id: "shp_011", carrier_do_no: "CDO-KBI-2026-011", forwarder_id: "fwd_001", issued_date: "2026-09-04", expired_date: "2026-09-07", release_location: "Noi Bai Cargo", container_no: null, local_charge_amount: 1700000, currency_code: "VND", status: "ISSUED", note: "Awaiting customs clearance before airport release." }),
        base({ id: "cdo_012", shipment_id: "shp_012", carrier_do_no: "CDO-KBI-2026-012", forwarder_id: "fwd_001", issued_date: "2026-09-18", expired_date: "2026-09-25", release_location: "Hai Phong Breakbulk Yard", container_no: null, local_charge_amount: 6400000, currency_code: "VND", status: "PENDING", note: "Oversized cargo requires yard handling order." }),
        base({ id: "cdo_013", shipment_id: "shp_013", carrier_do_no: "CDO-KBI-2026-013", forwarder_id: "fwd_001", issued_date: "2026-08-13", expired_date: "2026-08-20", release_location: "Hai Phong Port", container_no: "MRKU2468135", local_charge_amount: 4100000, currency_code: "VND", status: "RELEASED", note: "Released to warehouse transport." }),
        base({ id: "cdo_014", shipment_id: "shp_014", carrier_do_no: "CDO-KBI-2026-014", forwarder_id: "fwd_001", issued_date: "2026-08-29", expired_date: "2026-09-01", release_location: "Noi Bai Cargo", container_no: null, local_charge_amount: 2400000, currency_code: "VND", status: "RELEASED", note: "Priority release for high-value air cargo." })
    ],
    "domestic-transport-orders": [
        base({ id: "dto_001", dto_no: "DTO-KBI-2026-001", shipment_id: "shp_001", carrier_delivery_order_id: "cdo_001", truck_vendor_id: "fwd_001", origin: "Hai Phong Port", destination: "Kim Binh Factory", warehouse: "KBI Main Warehouse", vehicle_type: "Container Truck", vehicle_plate: null, driver_name: null, driver_phone: null, scheduled_pickup_at: "2026-07-17T01:00:00.000Z", actual_pickup_at: null, scheduled_delivery_at: "2026-07-17T09:00:00.000Z", actual_delivery_at: null, pod_document_ref: null, status: "QUOTE_CONFIRMED", note: "Ready to dispatch after release." }),
        base({ id: "dto_002", dto_no: "DTO-KBI-2026-002", shipment_id: "shp_002", carrier_delivery_order_id: "cdo_002", truck_vendor_id: "fwd_001", origin: "Hai Phong Port", destination: "Kim Binh Factory", warehouse: "KBI Main Warehouse", vehicle_type: "Box Truck", vehicle_plate: "15C-12345", driver_name: "Nguyen Van B", driver_phone: "+84-900-000-002", scheduled_pickup_at: "2026-07-03T01:00:00.000Z", actual_pickup_at: "2026-07-03T01:30:00.000Z", scheduled_delivery_at: "2026-07-03T09:00:00.000Z", actual_delivery_at: "2026-07-03T08:45:00.000Z", pod_document_ref: "POD-002", status: "CLOSED", note: null }),
        base({ id: "dto_003", dto_no: "DTO-KBI-2026-003", shipment_id: "shp_003", carrier_delivery_order_id: "cdo_003", truck_vendor_id: "fwd_001", origin: "Noi Bai Cargo", destination: "Kim Binh Factory", warehouse: "KBI Main Warehouse", vehicle_type: "Van", vehicle_plate: "29H-33333", driver_name: "Tran Van C", driver_phone: "+84-900-000-003", scheduled_pickup_at: "2026-06-27T10:00:00.000Z", actual_pickup_at: "2026-06-27T10:20:00.000Z", scheduled_delivery_at: "2026-06-27T14:00:00.000Z", actual_delivery_at: "2026-06-27T13:40:00.000Z", pod_document_ref: "POD-003", status: "POD_RECEIVED", note: null }),
        base({ id: "dto_004", dto_no: "DTO-KBI-2026-004", shipment_id: "shp_004", carrier_delivery_order_id: "cdo_004", truck_vendor_id: "fwd_001", origin: "Hai Phong Port", destination: "Kim Binh Factory", warehouse: "KBI Main Warehouse", vehicle_type: "Truck", vehicle_plate: null, driver_name: null, driver_phone: null, scheduled_pickup_at: "2026-07-22T01:00:00.000Z", actual_pickup_at: null, scheduled_delivery_at: "2026-07-22T09:00:00.000Z", actual_delivery_at: null, pod_document_ref: null, status: "DRAFT", note: null }),
        base({ id: "dto_005", dto_no: "DTO-KBI-2026-005", shipment_id: "shp_005", carrier_delivery_order_id: "cdo_005", truck_vendor_id: "fwd_001", origin: "Hai Phong Port", destination: "Kim Binh Factory", warehouse: "KBI Main Warehouse", vehicle_type: "20GP Container Truck", vehicle_plate: null, driver_name: null, driver_phone: null, scheduled_pickup_at: "2026-07-31T01:00:00.000Z", actual_pickup_at: null, scheduled_delivery_at: "2026-07-31T09:00:00.000Z", actual_delivery_at: null, pod_document_ref: null, status: "QUOTE_CONFIRMED", note: "Dispatch after CDO release." }),
        base({ id: "dto_006", dto_no: "DTO-KBI-2026-006", shipment_id: "shp_006", carrier_delivery_order_id: "cdo_006", truck_vendor_id: "fwd_001", origin: "Noi Bai Cargo", destination: "Kim Binh Factory", warehouse: "KBI Spare Parts Warehouse", vehicle_type: "Van", vehicle_plate: null, driver_name: null, driver_phone: null, scheduled_pickup_at: "2026-08-05T05:00:00.000Z", actual_pickup_at: null, scheduled_delivery_at: "2026-08-05T10:00:00.000Z", actual_delivery_at: null, pod_document_ref: null, status: "QUOTE_CONFIRMED", note: "Same-day airport delivery planned." }),
        base({ id: "dto_007", dto_no: "DTO-KBI-2026-007", shipment_id: "shp_007", carrier_delivery_order_id: "cdo_007", truck_vendor_id: "fwd_001", origin: "Hai Phong CFS", destination: "Kim Binh Factory", warehouse: "KBI Main Warehouse", vehicle_type: "Box Truck", vehicle_plate: "15C-77889", driver_name: "Pham Van D", driver_phone: "+84-900-000-007", scheduled_pickup_at: "2026-07-09T01:00:00.000Z", actual_pickup_at: "2026-07-09T01:20:00.000Z", scheduled_delivery_at: "2026-07-09T09:00:00.000Z", actual_delivery_at: "2026-07-09T08:50:00.000Z", pod_document_ref: "POD-007", status: "CLOSED", note: "Warehouse received full quantity." }),
        base({ id: "dto_008", dto_no: "DTO-KBI-2026-008", shipment_id: "shp_008", carrier_delivery_order_id: "cdo_008", truck_vendor_id: "fwd_001", origin: "Hai Phong Port", destination: "Kim Binh Factory", warehouse: "KBI Main Warehouse", vehicle_type: "40HC Container Truck", vehicle_plate: null, driver_name: null, driver_phone: null, scheduled_pickup_at: "2026-07-23T01:00:00.000Z", actual_pickup_at: null, scheduled_delivery_at: "2026-07-23T09:00:00.000Z", actual_delivery_at: null, pod_document_ref: null, status: "DRAFT", delayed_days: 3, note: "Waiting for customs clearance." }),
        base({ id: "dto_009", dto_no: "DTO-KBI-2026-009", shipment_id: "shp_009", carrier_delivery_order_id: "cdo_009", truck_vendor_id: "fwd_001", origin: "Pingxiang Border", destination: "Kim Binh Factory", warehouse: "KBI Main Warehouse", vehicle_type: "Curtain Side Truck", vehicle_plate: "29C-90909", driver_name: "Le Van E", driver_phone: "+84-900-000-009", scheduled_pickup_at: "2026-08-12T02:00:00.000Z", actual_pickup_at: "2026-08-12T02:10:00.000Z", scheduled_delivery_at: "2026-08-14T09:00:00.000Z", actual_delivery_at: "2026-08-14T08:30:00.000Z", pod_document_ref: "POD-009", status: "CLOSED", note: "Delivered after border clearance." }),
        base({ id: "dto_010", dto_no: "DTO-KBI-2026-010", shipment_id: "shp_010", carrier_delivery_order_id: "cdo_010", truck_vendor_id: "fwd_001", origin: "Hai Phong CFS", destination: "Kim Binh Factory", warehouse: "KBI Main Warehouse", vehicle_type: "Box Truck", vehicle_plate: "15C-51010", driver_name: "Hoang Van H", driver_phone: "+84-900-000-010", scheduled_pickup_at: "2026-08-27T01:00:00.000Z", actual_pickup_at: "2026-08-27T01:10:00.000Z", scheduled_delivery_at: "2026-08-27T09:00:00.000Z", actual_delivery_at: "2026-08-27T08:55:00.000Z", pod_document_ref: "POD-010", status: "CLOSED", note: "Palletized LCL cargo received." }),
        base({ id: "dto_011", dto_no: "DTO-KBI-2026-011", shipment_id: "shp_011", carrier_delivery_order_id: "cdo_011", truck_vendor_id: "fwd_001", origin: "Noi Bai Cargo", destination: "Kim Binh Factory", warehouse: "KBI Spare Parts Warehouse", vehicle_type: "Van", vehicle_plate: null, driver_name: null, driver_phone: null, scheduled_pickup_at: "2026-09-04T06:00:00.000Z", actual_pickup_at: null, scheduled_delivery_at: "2026-09-04T11:00:00.000Z", actual_delivery_at: null, pod_document_ref: null, status: "QUOTE_CONFIRMED", note: "Dispatch after airport release." }),
        base({ id: "dto_012", dto_no: "DTO-KBI-2026-012", shipment_id: "shp_012", carrier_delivery_order_id: "cdo_012", truck_vendor_id: "fwd_001", origin: "Hai Phong Breakbulk Yard", destination: "Kim Binh Factory", warehouse: "KBI Main Warehouse", vehicle_type: "Flatbed Truck", vehicle_plate: null, driver_name: null, driver_phone: null, scheduled_pickup_at: "2026-09-19T01:00:00.000Z", actual_pickup_at: null, scheduled_delivery_at: "2026-09-19T10:00:00.000Z", actual_delivery_at: null, pod_document_ref: null, status: "DRAFT", note: "Needs crane slot before pickup." }),
        base({ id: "dto_013", dto_no: "DTO-KBI-2026-013", shipment_id: "shp_013", carrier_delivery_order_id: "cdo_013", truck_vendor_id: "fwd_001", origin: "Hai Phong Port", destination: "Kim Binh Factory", warehouse: "KBI Main Warehouse", vehicle_type: "20GP Container Truck", vehicle_plate: "15C-51313", driver_name: "Dang Van K", driver_phone: "+84-900-000-013", scheduled_pickup_at: "2026-08-14T01:00:00.000Z", actual_pickup_at: "2026-08-14T01:30:00.000Z", scheduled_delivery_at: "2026-08-14T09:00:00.000Z", actual_delivery_at: "2026-08-14T09:15:00.000Z", pod_document_ref: "POD-013", status: "CLOSED", note: "Container returned empty same day." }),
        base({ id: "dto_014", dto_no: "DTO-KBI-2026-014", shipment_id: "shp_014", carrier_delivery_order_id: "cdo_014", truck_vendor_id: "fwd_001", origin: "Noi Bai Cargo", destination: "Kim Binh Factory", warehouse: "KBI Secure Cage", vehicle_type: "Secure Van", vehicle_plate: "29H-51414", driver_name: "Bui Van M", driver_phone: "+84-900-000-014", scheduled_pickup_at: "2026-08-29T09:00:00.000Z", actual_pickup_at: "2026-08-29T09:20:00.000Z", scheduled_delivery_at: "2026-08-29T13:00:00.000Z", actual_delivery_at: "2026-08-29T12:45:00.000Z", pod_document_ref: "POD-014", status: "POD_RECEIVED", note: "Received into secure cage pending QC." }),
        base({ id: "dto_015", dto_no: "DTO-KBI-2026-015", shipment_id: "shp_008", carrier_delivery_order_id: "cdo_008", truck_vendor_id: "fwd_001", origin: "Hai Phong Port", destination: "Kim Binh Factory", warehouse: "KBI Main Warehouse", vehicle_type: "40HC Container Truck", vehicle_plate: null, driver_name: null, driver_phone: null, scheduled_pickup_at: "2026-07-23T03:00:00.000Z", actual_pickup_at: null, scheduled_delivery_at: "2026-07-23T11:00:00.000Z", actual_delivery_at: null, pod_document_ref: null, status: "DRAFT", delayed_days: 3, note: "Second truck run for the second 40HC container." }),
        base({ id: "dto_016", dto_no: "DTO-KBI-2026-016", shipment_id: "shp_002", carrier_delivery_order_id: null, truck_vendor_id: "fwd_001", origin: "Hai Phong CFS", destination: "Kim Binh Factory", warehouse: "KBI Main Warehouse", vehicle_type: "Box Truck", vehicle_plate: null, driver_name: null, driver_phone: null, scheduled_pickup_at: "2026-07-09T02:00:00.000Z", actual_pickup_at: null, scheduled_delivery_at: "2026-07-09T10:00:00.000Z", actual_delivery_at: null, pod_document_ref: null, status: "QUOTE_CONFIRMED", note: "Consolidated LCL pickup for SHP-002 + SHP-007 (same POD VNHPH)." })
    ],
...
// Denormalize the SOP Task Template snapshot onto each runtime logistics task.
// The link is driven by each row's own `task_template_id` (single source), and the
// closure-required flag is INHERITED from the SOP template (`is_required_for_closure`)
// — never hand-set per instance. The DO-specific instance `task_name` is preserved.
function applySopTaskSnapshots(seedFiles) {
    const templatesById = Object.fromEntries((seedFiles["task-templates"] || []).map((template) => [template.id, template]));

    seedFiles["logistics-tasks"] = (seedFiles["logistics-tasks"] || []).map((task) => {
        const { role, ...nativeTask } = task;
        const template = templatesById[task.task_template_id];
        ...
        return {
            ...
            task_name: task.task_name || template.task_name,
            department: template.department,
            assignee_code: task.assignee_code || template.assignee_code,
            assignee: {
                ...task.assignee,
                department: template.department
            },
...
// Only backfill actuals the shipment's status actually implies: a BOOKING_CONFIRMED
// shipment has not sailed (no ATD) and an in-transit one has not landed (no ATA).
// Backfilling both unconditionally made every lô look perfectly on schedule.
function enrichShipmentTimeline(seedFiles) {
    ...
    const arrived = new Set(["ARRIVED", "CUSTOMS_DRAFT", "CUSTOMS_CLEARED", "DELIVERED"]);

    return seedFiles["shipments"].map((shipment) => ({
        ...shipment,
        atd: shipment.atd || (departed.has(shipment.status) ? shipment.etd : null) || null,
        ata: shipment.ata || (arrived.has(shipment.status) ? shipment.eta : null) || null
    }));
}
